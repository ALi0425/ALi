...
void main() {
	...
	`}function ih(n){let e=new WeakMap,t=null;function i(a){if(a&&a.isTexture){const c=a.mapping,l=c===Vs||c===Ws,u=c===vi||c===xi;if(l||u){let h=e.get(a);const f=h!==void 0?h.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==f)return t===null&&(t=new yo(n)),h=l?t.fromEquirectangular(a,h):t.fromCubemap(a,h),h.texture.pmremVersion=a.pmremVersion,e.set(a,h),h.texture;if(h!==void 0)return h.texture;{const m=a.image;return l&&m&&m.height>0||u&&m&&r(m)?(t===null&&(t=new yo(n)),h=l?t.fromEquirectangular(a):t.fromCubemap(a),h.texture.pmremVersion=a.pmremVersion,e.set(a,h),a.addEventListener("dispose",s),h.texture):null}}}return a}function r(a){let c=0;const l=6;for(let u=0;u<l;u++)a[u]!==void 0&&c++;return c===l}function s(a){const c=a.target;c.removeEventListener("dispose",s);const l=e.get(c);l!==void 0&&(e.delete(c),l.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:i,dispose:o}}function rh(n){const e={};function t(i){if(e[i]!==void 0)return e[i];let r;switch(i){case"WEBGL_depth_texture":r=n.getExtension("WEBGL_depth_texture")||n.getExtension("MOZ_WEBGL_depth_texture")||n.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=n.getExtension("EXT_texture_filter_anisotropic")||n.getExtension("MOZ_EXT_texture_filter_anisotropic")||n.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=n.getExtension("WEBGL_compressed_texture_s3tc")||n.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=n.getExtension("WEBGL_compressed_texture_pvrtc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=n.getExtension(i)}return e[i]=r,r}return{has:function(i){return t(i)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(i){const r=t(i);return r===null&&Fi("THREE.WebGLRenderer: "+i+" extension not supported."),r}}}function sh(n,e,t,i){const r={},s=new WeakMap;function o(h){const f=h.target;f.index!==null&&e.remove(f.index);for(const g in f.attributes)e.remove(f.attributes[g]);for(const g in f.morphAttributes){const _=f.morphAttributes[g];for(let p=0,d=_.length;p<d;p++)e.remove(_[p])}f.removeEventListener("dispose",o),delete r[f.id];const m=s.get(f);m&&(e.remove(m),s.delete(f)),i.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,t.memory.geometries--}function a(h,f){return r[f.id]===!0||(f.addEventListener("dispose",o),r[f.id]=!0,t.memory.geometries++),f}function c(h){const f=h.attributes;for(const g in f)e.update(f[g],n.ARRAY_BUFFER);const m=h.morphAttributes;for(const g in m){const _=m[g];for(let p=0,d=_.length;p<d;p++)e.update(_[p],n.ARRAY_BUFFER)}}function l(h){const f=[],m=h.index,g=h.attributes.position;let _=0;if(m!==null){const b=m.array;_=m.version;for(let S=0,M=b.length;S<M;S+=3){const U=b[S+0],A=b[S+1],R=b[S+2];f.push(U,A,A,R,R,U)}}else if(g!==void 0){const b=g.array;_=g.version;for(let S=0,M=b.length/3-1;S<M;S+=3){const U=S+0,A=S+1,R=S+2;f.push(U,A,A,R,R,U)}}else return;const p=new(Ml(f)?Rl:wl)(f,1);p.version=_;const d=s.get(h);d&&e.remove(d),s.set(h,p)}function u(h){const f=s.get(h);if(f){const m=h.index;m!==null&&f.version<m.version&&l(h)}else l(h);return s.get(h)}return{get:a,update:c,getWireframeAttribute:u}}function ah(n,e,t){let i;function r(f){i=f}let s,o;function a(f){s=f.type,o=f.bytesPerElement}function c(f,m){n.drawElements(i,m,s,f*o),t.update(m,i,1)}function l(f,m,g){g!==0&&(n.drawElementsInstanced(i,m,s,f*o,g),t.update(m,i,g))}function u(f,m,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,m,0,s,f,0,g);let p=0;for(let d=0;d<g;d++)p+=m[d];t.update(p,i,1)}function h(f,m,g,_){if(g===0)return;const p=e.get("WEBGL_multi_draw");if(p===null)for(let d=0;d<f.length;d++)l(f[d]/o,m[d],_[d]);else{p.multiDrawElementsInstancedWEBGL(i,m,0,s,f,0,_,0,g);let d=0;for(let b=0;b<g;b++)d+=m[b]*_[b];t.update(d,i,1)}}this.setMode=r,this.setIndex=a,this.render=c,this.renderInstances=l,this.renderMultiDraw=u,this.renderMultiDrawInstances=h}function oh(n){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,o,a){switch(t.calls++,o){case n.TRIANGLES:t.triangles+=a*(s/3);break;case n.LINES:t.lines+=a*(s/2);break;case n.LINE_STRIP:t.lines+=a*(s-1);break;case n.LINE_LOOP:t.lines+=a*s;break;case n.POINTS:t.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:i}}function lh(n,e,t){const i=new WeakMap,r=new rt;function s(o,a,c){const l=o.morphTargetInfluences,u=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,h=u!==void 0?u.length:0;let f=i.get(a);if(f===void 0||f.count!==h){let E=function(){I.dispose(),i.delete(a),a.removeEventListener("dispose",E)};var m=E;f!==void 0&&f.texture.dispose();const g=a.morphAttributes.position!==void 0,_=a.morphAttributes.normal!==void 0,p=a.morphAttributes.color!==void 0,d=a.morphAttributes.position||[],b=a.morphAttributes.normal||[],S=a.morphAttributes.color||[];let M=0;g===!0&&(M=1),_===!0&&(M=2),p===!0&&(M=3);let U=a.attributes.position.count*M,A=1;U>e.maxTextureSize&&(A=Math.ceil(U/e.maxTextureSize),U=e.maxTextureSize);const R=new Float32Array(U*A*4*h),I=new El(R,U,A,h);I.type=on,I.needsUpdate=!0;const y=M*4;for(let w=0;w<h;w++){const G=d[w],z=b[w],$=S[w],K=U*A*4*w;for(let X=0;X<G.count;X++){const j=X*y;g===!0&&(r.fromBufferAttribute(G,X),R[K+j+0]=r.x,R[K+j+1]=r.y,R[K+j+2]=r.z,R[K+j+3]=0),_===!0&&(r.fromBufferAttribute(z,X),R[K+j+4]=r.x,R[K+j+5]=r.y,R[K+j+6]=r.z,R[K+j+7]=0),p===!0&&(r.fromBufferAttribute($,X),R[K+j+8]=r.x,R[K+j+9]=r.y,R[K+j+10]=r.z,R[K+j+11]=$.itemSize===4?r.w:1)}}f={count:h,texture:I,size:new Ye(U,A)},i.set(a,f),a.addEventListener("dispose",E)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)c.getUniforms().setValue(n,"morphTexture",o.morphTexture,t);else{let g=0;for(let p=0;p<l.length;p++)g+=l[p];const _=a.morphTargetsRelative?1:1-g;c.getUniforms().setValue(n,"morphTargetBaseInfluence",_),c.getUniforms().setValue(n,"morphTargetInfluences",l)}c.getUniforms().setValue(n,"morphTargetsTexture",f.texture,t),c.getUniforms().setValue(n,"morphTargetsTextureSize",f.size)}return{update:s}}function ch(n,e,t,i){let r=new WeakMap;function s(c){const l=i.render.frame,u=c.geometry,h=e.get(c,u);if(r.get(h)!==l&&(e.update(h),r.set(h,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",a)===!1&&c.addEventListener("dispose",a),r.get(c)!==l&&(t.update(c.instanceMatrix,n.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,n.ARRAY_BUFFER),r.set(c,l))),c.isSkinnedMesh){const f=c.skeleton;r.get(f)!==l&&(f.update(),r.set(f,l))}return h}function o(){r=new WeakMap}function a(c){const l=c.target;l.removeEventListener("dispose",a),t.remove(l.instanceMatrix),l.instanceColor!==null&&t.remove(l.instanceColor)}return{update:s,dispose:o}}class Ul extends mt{constructor(e,t,i,r,s,o,a,c,l,u=hi){if(u!==hi&&u!==Si)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");i===void 0&&u===hi&&(i=Xn),i===void 0&&u===Si&&(i=Mi),super(null,r,s,o,a,c,u,i,l),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=a!==void 0?a:Gt,this.minFilter=c!==void 0?c:Gt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const Nl=new mt,wo=new Ul(1,1),Fl=new El,Ol=new Yc,Bl=new Pl,Ro=[],Co=[],Lo=new Float32Array(16),Po=new Float32Array(9),Do=new Float32Array(4);function bi(n,e,t){const i=n[0];if(i<=0||i>0)return n;const r=e*t;let s=Ro[r];if(s===void 0&&(s=new Float32Array(r),Ro[r]=s),e!==0){i.toArray(s,0);for(let o=1,a=0;o!==e;++o)a+=t,n[o].toArray(s,a)}return s}function at(n,e){if(n.length!==e.length)return!1;for(let t=0,i=n.length;t<i;t++)if(n[t]!==e[t])return!1;return!0}function ot(n,e){for(let t=0,i=e.length;t<i;t++)n[t]=e[t]}function Zr(n,e){let t=Co[e];t===void 0&&(t=new Int32Array(e),Co[e]=t);for(let i=0;i!==e;++i)t[i]=n.allocateTextureUnit();return t}function dh(n,e){const t=this.cache;t[0]!==e&&(n.uniform1f(this.addr,e),t[0]=e)}function uh(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(at(t,e))return;n.uniform2fv(this.addr,e),ot(t,e)}}function fh(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(at(t,e))return;n.uniform3fv(this.addr,e),ot(t,e)}}function hh(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(at(t,e))return;n.uniform4fv(this.addr,e),ot(t,e)}}function ph(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(at(t,e))return;n.uniformMatrix2fv(this.addr,!1,e),ot(t,e)}else{if(at(t,i))return;Do.set(i),n.uniformMatrix2fv(this.addr,!1,Do),ot(t,i)}}function mh(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(at(t,e))return;n.uniformMatrix3fv(this.addr,!1,e),ot(t,e)}else{if(at(t,i))return;Po.set(i),n.uniformMatrix3fv(this.addr,!1,Po),ot(t,i)}}function gh(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(at(t,e))return;n.uniformMatrix4fv(this.addr,!1,e),ot(t,e)}else{if(at(t,i))return;Lo.set(i),n.uniformMatrix4fv(this.addr,!1,Lo),ot(t,i)}}function _h(n,e){const t=this.cache;t[0]!==e&&(n.uniform1i(this.addr,e),t[0]=e)}function vh(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(at(t,e))return;n.uniform2iv(this.addr,e),ot(t,e)}}function xh(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(at(t,e))return;n.uniform3iv(this.addr,e),ot(t,e)}}function Mh(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(at(t,e))return;n.uniform4iv(this.addr,e),ot(t,e)}}function Sh(n,e){const t=this.cache;t[0]!==e&&(n.uniform1ui(this.addr,e),t[0]=e)}function Eh(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(at(t,e))return;n.uniform2uiv(this.addr,e),ot(t,e)}}function yh(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(at(t,e))return;n.uniform3uiv(this.addr,e),ot(t,e)}}function Th(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(at(t,e))return;n.uniform4uiv(this.addr,e),ot(t,e)}}function bh(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r);let s;this.type===n.SAMPLER_2D_SHADOW?(wo.compareFunction=xl,s=wo):s=Nl,t.setTexture2D(e||s,r)}function Ah(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture3D(e||Ol,r)}function wh(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTextureCube(e||Bl,r)}function Rh(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture2DArray(e||Fl,r)}function Ch(n){switch(n){case 5126:return dh;case 35664:return uh;case 35665:return fh;case 35666:return hh;case 35674:return ph;case 35675:return mh;case 35676:return gh;case 5124:case 35670:return _h;case 35667:case 35671:return vh;case 35668:case 35672:return xh;case 35669:case 35673:return Mh;case 5125:return Sh;case 36294:return Eh;case 36295:return yh;case 36296:return Th;case 35678:case 36198:case 36298:case 36306:case 35682:return bh;case 35679:case 36299:case 36307:return Ah;case 35680:case 36300:case 36308:case 36293:return wh;case 36289:case 36303:case 36311:case 36292:return Rh}}function Lh(n,e){n.uniform1fv(this.addr,e)}function Ph(n,e){const t=bi(e,this.size,2);n.uniform2fv(this.addr,t)}function Dh(n,e){const t=bi(e,this.size,3);n.uniform3fv(this.addr,t)}function Ih(n,e){const t=bi(e,this.size,4);n.uniform4fv(this.addr,t)}function Uh(n,e){const t=bi(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,t)}function Nh(n,e){const t=bi(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,t)}function Fh(n,e){const t=bi(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,t)}function Oh(n,e){n.uniform1iv(this.addr,e)}function Bh(n,e){n.uniform2iv(this.addr,e)}function zh(n,e){n.uniform3iv(this.addr,e)}function Hh(n,e){n.uniform4iv(this.addr,e)}function kh(n,e){n.uniform1uiv(this.addr,e)}function Gh(n,e){n.uniform2uiv(this.addr,e)}function Vh(n,e){n.uniform3uiv(this.addr,e)}function Wh(n,e){n.uniform4uiv(this.addr,e)}function Xh(n,e,t){const i=this.cache,r=e.length,s=Zr(t,r);at(i,s)||(n.uniform1iv(this.addr,s),ot(i,s));for(let o=0;o!==r;++o)t.setTexture2D(e[o]||Nl,s[o])}function qh(n,e,t){const i=this.cache,r=e.length,s=Zr(t,r);at(i,s)||(n.uniform1iv(this.addr,s),ot(i,s));for(let o=0;o!==r;++o)t.setTexture3D(e[o]||Ol,s[o])}function Yh(n,e,t){const i=this.cache,r=e.length,s=Zr(t,r);at(i,s)||(n.uniform1iv(this.addr,s),ot(i,s));for(let o=0;o!==r;++o)t.setTextureCube(e[o]||Bl,s[o])}function $h(n,e,t){const i=this.cache,r=e.length,s=Zr(t,r);at(i,s)||(n.uniform1iv(this.addr,s),ot(i,s));for(let o=0;o!==r;++o)t.setTexture2DArray(e[o]||Fl,s[o])}function Kh(n){switch(n){case 5126:return Lh;case 35664:return Ph;case 35665:return Dh;case 35666:return Ih;case 35674:return Uh;case 35675:return Nh;case 35676:return Fh;case 5124:case 35670:return Oh;case 35667:case 35671:return Bh;case 35668:case 35672:return zh;case 35669:case 35673:return Hh;case 5125:return kh;case 36294:return Gh;case 36295:return Vh;case 36296:return Wh;case 35678:case 36198:case 36298:case 36306:case 35682:return Xh;case 35679:case 36299:case 36307:return qh;case 35680:case 36300:case 36308:case 36293:return Yh;case 36289:case 36303:case 36311:case 36292:return $h}}class Zh{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.setValue=Ch(t.type)}}class jh{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Kh(t.type)}}class Jh{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(e,t[a.id],i)}}}const As=/(\w+)(\])?(\[|\.)?/g;function Io(n,e){n.seq.push(e),n.map[e.id]=e}function Qh(n,e,t){const i=n.name,r=i.length;for(As.lastIndex=0;;){const s=As.exec(i),o=As.lastIndex;let a=s[1];const c=s[2]==="]",l=s[3];if(c&&(a=a|0),l===void 0||l==="["&&o+2===r){Io(t,l===void 0?new Zh(a,n,e):new jh(a,n,e));break}else{let h=t.map[a];h===void 0&&(h=new Jh(a),Io(t,h)),t=h}}}class Ur{constructor(e,t){this.seq=[],this.map={};const i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<i;++r){const s=e.getActiveUniform(t,r),o=e.getUniformLocation(t,s.name);Qh(s,o,this)}}setValue(e,t,i,r){const s=this.map[t];s!==void 0&&s.setValue(e,i,r)}setOptional(e,t,i){const r=t[i];r!==void 0&&this.setValue(e,i,r)}static upload(e,t,i,r){for(let s=0,o=t.length;s!==o;++s){const a=t[s],c=i[a.id];c.needsUpdate!==!1&&a.setValue(e,c.value,r)}}static seqWithValue(e,t){const i=[];for(let r=0,s=e.length;r!==s;++r){const o=e[r];o.id in t&&i.push(o)}return i}}function Uo(n,e,t){const i=n.createShader(e);return n.shaderSource(i,t),n.compileShader(i),i}const ep=37297;let tp=0;function np(n,e){const t=n.split(`
`),i=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let o=r;o<s;o++){const a=o+1;i.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return i.join(`
`)}const No=new Ce;function ip(n){He._getMatrix(No,He.workingColorSpace,n);const e=`mat3( ${No.elements.map(t=>t.toFixed(4))} )`;switch(He.getTransfer(n)){case Yr:return[e,"LinearTransferOETF"];case qe:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",n),[e,"LinearTransferOETF"]}}function Fo(n,e,t){const i=n.getShaderParameter(e,n.COMPILE_STATUS),r=n.getShaderInfoLog(e).trim();if(i&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const o=parseInt(s[1]);return t.toUpperCase()+`

`+r+`

`+np(n.getShaderSource(e),o)}else return r}function rp(n,e){const t=ip(e);return[`vec4 ${n}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function sp(n,e){let t;switch(e){case xc:t="Linear";break;case Mc:t="Reinhard";break;case Sc:t="Cineon";break;case Ec:t="ACESFilmic";break;case Tc:t="AgX";break;case bc:t="Neutral";break;case yc:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const br=new F;function ap(){He.getLuminanceCoefficients(br);const n=br.x.toFixed(4),e=br.y.toFixed(4),t=br.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function op(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",n.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Oi).join(`
`)}function lp(n){const e=[];for(const t in n){const i=n[t];i!==!1&&e.push("#define "+t+" "+i)}return e.join(`
`)}function cp(n,e){const t={},i=n.getProgramParameter(e,n.ACTIVE_ATTRIBUTES);for(let r=0;r<i;r++){const s=n.getActiveAttrib(e,r),o=s.name;let a=1;s.type===n.FLOAT_MAT2&&(a=2),s.type===n.FLOAT_MAT3&&(a=3),s.type===n.FLOAT_MAT4&&(a=4),t[o]={type:s.type,location:n.getAttribLocation(e,o),locationSize:a}}return t}function Oi(n){return n!==""}function Oo(n,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return n.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Bo(n,e){return n.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const dp=/^[ \t]*#include +<([\w\d./]+)>/gm;function Ma(n){return n.replace(dp,fp)}const up=new Map;function fp(n,e){let t=Pe[e];if(t===void 0){const i=up.get(e);if(i!==void 0)t=Pe[i],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,i);else throw new Error("Can not resolve #include <"+e+">")}return Ma(t)}const hp=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function zo(n){return n.replace(hp,pp)}function pp(n,e,t,i){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=i.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function Ho(n){let e=`precision ${n.precision} float;
...
#define LOW_PRECISION`),e}function mp(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===al?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===Jl?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===sn&&(e="SHADOWMAP_TYPE_VSM"),e}function gp(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case vi:case xi:e="ENVMAP_TYPE_CUBE";break;case qr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function _p(n){let e="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case xi:e="ENVMAP_MODE_REFRACTION";break}return e}function vp(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case ol:e="ENVMAP_BLENDING_MULTIPLY";break;case _c:e="ENVMAP_BLENDING_MIX";break;case vc:e="ENVMAP_BLENDING_ADD";break}return e}function xp(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:i,maxMip:t}}function Mp(n,e,t,i){const r=n.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const c=mp(t),l=gp(t),u=_p(t),h=vp(t),f=xp(t),m=op(t),g=lp(s),_=r.createProgram();let p,d,b=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
  ...
  `,n.isName&&(e.style.backgroundColor="transparent"),e}function mm(n){const e=document.createElement("div");return e.className="project-label",e.dataset.key=n.key,e.innerHTML=`
  ...
  `,e}function gm(n,e){const t=new Bi,i=e?200:1200,r=e?1.2:4.8,s=new hn;s.setAttribute("position",new Vt(Cs(i,r),3));const o=new zl({size:.18,map:hm(),blending:Is,depthWrite:!1,transparent:!0,color:new We(.133,.773,.369),opacity:.75,sizeAttenuation:!0}),a=new tm(s,o);t.add(a);const c=new Float32Array(s.attributes.position.array),l=s.attributes.position.array,u=[];let h=null;fm(e).forEach(b=>{const S=pm(b),M=new Rs(S);M.position.set(b.x,b.y,b.z),t.add(M),u.push({obj:M,el:S,data:b}),b.isName&&(h={obj:M,el:S,data:b})});const f=Cs(jo.length,r*1.04),m=[],g=e?.4:1;jo.forEach((b,S)=>{const M=document.createElement("span");M.textContent=b.text,M.style.cssText=`
      font-family: 'Space Mono', 'Courier New', monospace;
    ...
    `;const U=new Rs(M);U.position.set(f[S*3],f[S*3+1],f[S*3+2]),t.add(U),m.push({obj:U,el:M,data:b})});const _=null,p=Cs(Jo.length,r*1.02),d=[];return Jo.forEach((b,S)=>{const M=mm(b),U=new Rs(M);U.position.set(p[S*3],p[S*3+1],p[S*3+2]),t.add(U),d.push({obj:U,el:M,data:b,idx:S})}),n.add(t),{group:t,particles:a,particleMat:o,particleGeo:s,origPos:c,particlePos:l,nodeRefs:d,infoRefs:u,nameRef:h,nameFixedEl:_,tagRefs:m,velocities:null,targets:null,exploding:!1,explosionProgress:0}}function _m(n,e){if(Ht()!==Oe.IDLE)return;am(e,.055),n._autoRotY=(n._autoRotY||0)+cm,n._wobbleX=(n._wobbleX||0)+Math.sin(Date.now()*3e-4)*15e-5,n.group.rotation.y=n._autoRotY+e.currentX*.08,n.group.rotation.x=n._wobbleX+e.currentY*.08;const t=1+Math.sin(Date.now()*um*.001)*dm;n.group.scale.setScalar(t),n.particleMat.opacity=.6+Math.sin(Date.now()*.0015)*.15}function vm(){const n=document.getElementById("status-bar");n&&(n.innerHTML=`
...
● 核心突破
→ 复杂业务解构：负责全类型项目分摊与跨项目报工、阶段性劳务报工管理、经营性项目关联研发项目等相关需求梳理与方案产出，涉及现有系统逻辑重构。`}};let Dt=null,Hr=!1;function xm(n){if(Hr){kr();return}const t=Qo[{a1:"a1",a2:"a2",b1:"b1",b2:"b2",b3:"b3"}[n]]||Qo.a1;Mm(),Sm(t),document.body.style.overflow="hidden",Dt.classList.add("active"),Hr=!0}function kr(){!Dt||!Hr||(Dt.classList.remove("active"),Hr=!1,document.body.style.overflow="")}function Mm(){if(Dt){Dt.innerHTML="";return}Dt=document.createElement("div"),Dt.id="terminal-overlay",document.body.appendChild(Dt)}function Sm(n){Dt.innerHTML=`
    <!-- backdrop -->
  ...
  `,Dt.querySelectorAll(".bb-image video").forEach(e=>{const t=e.dataset.src;t&&(e.src=t,e.addEventListener("error",()=>{const i=e.closest(".bb-image")||e.parentElement;if(!i)return;const r=i.closest(".tt-browser");if(!r)return;const s=r.querySelector(".bb-bar"),o=document.createElement("div");o.className="bb-content";const a=s==null?void 0:s.querySelector(".bb-url span:last-child"),c=(a==null?void 0:a.textContent)||n.title||"";o.innerHTML=`
      ...
      `,e.remove(),i.replaceWith(o)}),setTimeout(()=>{e.paused&&e.play().catch(()=>{})},200))}),Dt.querySelector("#tt-close").addEventListener("click",kr),Dt.querySelector(".tt-backdrop").addEventListener("click",kr)}function Em(n){return n.split(`
`).map(t=>{const i=t.trim();return i?i.startsWith("【")?`<div class="cl-section"><span class="cl-dot">●</span> ${kn(i.replace(/[【】]/g,""))}</div>`:i.startsWith("●")?`<div class="cl-section"><span class="cl-dot">●</span> ${kn(i.slice(1).trim())}</div>`:i.startsWith("→")?`<div class="cl-bullet"><span class="cl-arrow">→</span>${kn(i.slice(1).trim())}</div>`:/\d+%/.test(i)||/\d+ 项/.test(i)||/^\d+/.test(i)?`<div class="cl-highlight">${kn(i)}</div>`:`<div class="cl-line">${kn(i)}</div>`:'<div class="cl-empty"></div>'}).join("")}function kn(n){return n.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}let Yt=null;const ym={b1:{name:"科技管理应用",tag:"B端·科技管理"},b2:{name:"巡查问题在线管理",tag:"B端·合规治理"},b3:{name:"项目管理应用",tag:"B端·全生命周期"}};function Hl(n){const e=document.getElementById("sim-rare-overlay");e&&e.remove(),Yt=null;const t=ym[n]||{name:"未知项目"};Yt=document.createElement("div"),Yt.id="sim-rare-overlay",Yt.innerHTML=`
  ...
  `}function Xl(n){const e={conflict:`
    ...
    `};return e[n]||e.conflict}function sg(n,e){const t=e.querySelector("#diff-canvas-view");t&&(t.innerHTML=Xl(n))}function ag(){Wl(),wa=!1,Wi=0,window.__safariTriggered=!1}let Bt=null,pt=0,bt=0,Xt=0,wn=null,Xi=0,gi=null,qi=null,Yi=null,$i=null,Ki=!1,Kt=null;const og=500;function sl(){const n=document.getElementById("terminal-overlay");if(n&&n.classList.contains("active"))return!0;const e=document.getElementById("safari-overlay");if(e&&e.classList.contains("active"))return!0;const t=document.getElementById("sim-rare-overlay");return!!(t&&t.classList.contains("active"))}function lg(){if(Bt){Bt.style.display="";return}Bt=document.createElement("div"),Bt.id="contact-overlay",Bt.innerHTML=`
  ...
  `,document.body.appendChild(Bt)}function Ca(){const n=document.getElementById("co-scroll-container");if(!n)return;const e=(1-pt)*100;n.style.transform=`translateY(${e}%)`;const t=pt>.02;Bt.style.pointerEvents=t?"auto":"none",Bt.style.opacity=t?"1":"0",document.body.style.overflow=t?"hidden":""}function ql(n){wn=requestAnimationFrame(ql);const e=Math.min((n-(Xi||n))/16,4);Xi=n;const t=.045*e,r=(bt-pt)*t-Xt*.8;if(Xt+=r*e,pt+=Xt*e,pt<0&&(pt=0,Xt=0),pt>1&&(pt=1,Xt=0),Ca(),Math.abs(pt-bt)<.003&&Math.abs(Xt)<5e-4){const s=pt>.02;pt=bt,Xt=0,Ca(),cancelAnimationFrame(wn),wn=null,Xi=0,s&&pt<.02&&window.dispatchEvent(new CustomEvent("contact-closed"))}}function Xr(){wn||(Xi=0,wn=requestAnimationFrame(ql))}function cg(n){if(gi)return;lg(),gi=i=>{sl()||(bt=Math.max(0,Math.min(1,bt+i.deltaY/500)),Xr())},n.addEventListener("wheel",gi,{passive:!0});let e=null,t=0;qi=i=>{i.touches.length===1&&(sl()||Ki||(e=i.touches[0].clientY,t=bt,Xt=0))},Yi=i=>{if(e===null||i.touches.length!==1)return;const r=(e-i.touches[0].clientY)/window.innerHeight*1.8;bt=Math.max(0,Math.min(1,t+r)),pt=bt,Ca()},$i=()=>{e=null,pt>.3?bt=1:(bt=0,Ki=!0,Kt&&clearTimeout(Kt),Kt=setTimeout(()=>{Ki=!1,Kt=null},og)),Xt=0,Xr()},n.addEventListener("touchstart",qi,{passive:!0}),n.addEventListener("touchmove",Yi,{passive:!0}),n.addEventListener("touchend",$i,{passive:!0})}function dg(n){gi&&(n.removeEventListener("wheel",gi),gi=null),qi&&(n.removeEventListener("touchstart",qi),qi=null),Yi&&(n.removeEventListener("touchmove",Yi),Yi=null),$i&&(n.removeEventListener("touchend",$i),$i=null),bt=0,pt=0,Xt=0,Xi=0,Ki=!1,Kt&&(clearTimeout(Kt),Kt=null),wn&&(cancelAnimationFrame(wn),wn=null);const e=document.getElementById("co-scroll-container");e&&(e.style.transform="translateY(100%)"),Bt&&(Bt.style.opacity="0",Bt.style.pointerEvents="none")}function ug(){Ki=!1,Kt&&(clearTimeout(Kt),Kt=null),bt=1,Xr()}document.addEventListener("keydown",n=>{n.key==="Escape"&&(bt=0,Xr())});async function fg(){const n=document.getElementById("three-container"),e=window.innerWidth<768,{scene:t,camera:i,renderer:r,labelRenderer:s}=rm(n,e),o=gm(t,e),a=sm();vm(),zm(t,o,i),Qm(),ng(),zi(Oe.IDLE,()=>{Im(),ag()}),setTimeout(()=>{Ds("system-info"),Ds("camera-indicator"),setTimeout(()=>Ds("guide-hint"),1200)},400);function c(){requestAnimationFrame(c);const l=Ht();l===Oe.IDLE?(_m(o,a),window.__contactMounted&&(dg(window),window.__contactMounted=!1)):l===Oe.FLOATING&&(qm(o,16),Pm(),window.__contactMounted||(cg(window),window.__contactMounted=!0)),r.render(t,i),s.render(t,i)}c(),window.addEventListener("resize",()=>{const l=window.innerWidth,u=window.innerHeight;i.aspect=l/u,i.updateProjectionMatrix(),r.setSize(l,u),s.setSize(l,u)}),window.addEventListener("open-contact",()=>ug()),window.addEventListener("contact-closed",()=>{var l;Ht()===Oe.IDLE&&((l=window.__triggerExplosion)==null||l.call(window))}),console.log("%c⏣  KERNEL ONLINE  ⏣","color: #22c55e; font-size: 16px; font-weight: bold; font-family: monospace;"),console.log("%cSYSTEM_STATUS: AUTHORIZED_BY_JJ","color: #22c55e; font-family: monospace;"),console.log("%cCURIOSITY: 100%  |  TEAMWORK: ACTIVE","color: #525252; font-family: monospace;")}function Ds(n){const e=document.getElementById(n);e&&(e.style.opacity="",e.classList.remove("opacity-0"),n==="guide-hint"&&setTimeout(()=>e.classList.add("animate-pulse"),1200))}fg().catch(console.error);
