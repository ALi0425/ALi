...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:xn,depthTest:!1,depthWrite:!1})}function co(){return new yn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ea(),fragmentShader:`
		...
		`,blending:xn,depthTest:!1,depthWrite:!1})}function uo(){return new yn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ea(),fragmentShader:`
	...
	`}function zf(n){let e=new WeakMap,t=null;function i(o){if(o&&o.isTexture){const l=o.mapping,c=l===Cs||l===Ps,f=l===di||l===ui;if(c||f){let h=e.get(o);const u=h!==void 0?h.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==u)return t===null&&(t=new oo(n)),h=c?t.fromEquirectangular(o,h):t.fromCubemap(o,h),h.texture.pmremVersion=o.pmremVersion,e.set(o,h),h.texture;if(h!==void 0)return h.texture;{const m=o.image;return c&&m&&m.height>0||f&&m&&r(m)?(t===null&&(t=new oo(n)),h=c?t.fromEquirectangular(o):t.fromCubemap(o),h.texture.pmremVersion=o.pmremVersion,e.set(o,h),o.addEventListener("dispose",s),h.texture):null}}}return o}function r(o){let l=0;const c=6;for(let f=0;f<c;f++)o[f]!==void 0&&l++;return l===c}function s(o){const l=o.target;l.removeEventListener("dispose",s);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:i,dispose:a}}function Hf(n){const e={};function t(i){if(e[i]!==void 0)return e[i];let r;switch(i){case"WEBGL_depth_texture":r=n.getExtension("WEBGL_depth_texture")||n.getExtension("MOZ_WEBGL_depth_texture")||n.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=n.getExtension("EXT_texture_filter_anisotropic")||n.getExtension("MOZ_EXT_texture_filter_anisotropic")||n.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=n.getExtension("WEBGL_compressed_texture_s3tc")||n.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=n.getExtension("WEBGL_compressed_texture_pvrtc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=n.getExtension(i)}return e[i]=r,r}return{has:function(i){return t(i)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(i){const r=t(i);return r===null&&wi("THREE.WebGLRenderer: "+i+" extension not supported."),r}}}function kf(n,e,t,i){const r={},s=new WeakMap;function a(h){const u=h.target;u.index!==null&&e.remove(u.index);for(const g in u.attributes)e.remove(u.attributes[g]);for(const g in u.morphAttributes){const _=u.morphAttributes[g];for(let p=0,d=_.length;p<d;p++)e.remove(_[p])}u.removeEventListener("dispose",a),delete r[u.id];const m=s.get(u);m&&(e.remove(m),s.delete(u)),i.releaseStatesOfGeometry(u),u.isInstancedBufferGeometry===!0&&delete u._maxInstanceCount,t.memory.geometries--}function o(h,u){return r[u.id]===!0||(u.addEventListener("dispose",a),r[u.id]=!0,t.memory.geometries++),u}function l(h){const u=h.attributes;for(const g in u)e.update(u[g],n.ARRAY_BUFFER);const m=h.morphAttributes;for(const g in m){const _=m[g];for(let p=0,d=_.length;p<d;p++)e.update(_[p],n.ARRAY_BUFFER)}}function c(h){const u=[],m=h.index,g=h.attributes.position;let _=0;if(m!==null){const b=m.array;_=m.version;for(let E=0,S=b.length;E<S;E+=3){const U=b[E+0],w=b[E+1],R=b[E+2];u.push(U,w,w,R,R,U)}}else if(g!==void 0){const b=g.array;_=g.version;for(let E=0,S=b.length/3-1;E<S;E+=3){const U=E+0,w=E+1,R=E+2;u.push(U,w,w,R,R,U)}}else return;const p=new(il(u)?ul:dl)(u,1);p.version=_;const d=s.get(h);d&&e.remove(d),s.set(h,p)}function f(h){const u=s.get(h);if(u){const m=h.index;m!==null&&u.version<m.version&&c(h)}else c(h);return s.get(h)}return{get:o,update:l,getWireframeAttribute:f}}function Gf(n,e,t){let i;function r(u){i=u}let s,a;function o(u){s=u.type,a=u.bytesPerElement}function l(u,m){n.drawElements(i,m,s,u*a),t.update(m,i,1)}function c(u,m,g){g!==0&&(n.drawElementsInstanced(i,m,s,u*a,g),t.update(m,i,g))}function f(u,m,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,m,0,s,u,0,g);let p=0;for(let d=0;d<g;d++)p+=m[d];t.update(p,i,1)}function h(u,m,g,_){if(g===0)return;const p=e.get("WEBGL_multi_draw");if(p===null)for(let d=0;d<u.length;d++)c(u[d]/a,m[d],_[d]);else{p.multiDrawElementsInstancedWEBGL(i,m,0,s,u,0,_,0,g);let d=0;for(let b=0;b<g;b++)d+=m[b]*_[b];t.update(d,i,1)}}this.setMode=r,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=f,this.renderMultiDrawInstances=h}function Vf(n){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,a,o){switch(t.calls++,a){case n.TRIANGLES:t.triangles+=o*(s/3);break;case n.LINES:t.lines+=o*(s/2);break;case n.LINE_STRIP:t.lines+=o*(s-1);break;case n.LINE_LOOP:t.lines+=o*s;break;case n.POINTS:t.points+=o*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:i}}function Wf(n,e,t){const i=new WeakMap,r=new rt;function s(a,o,l){const c=a.morphTargetInfluences,f=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,h=f!==void 0?f.length:0;let u=i.get(o);if(u===void 0||u.count!==h){let M=function(){I.dispose(),i.delete(o),o.removeEventListener("dispose",M)};var m=M;u!==void 0&&u.texture.dispose();const g=o.morphAttributes.position!==void 0,_=o.morphAttributes.normal!==void 0,p=o.morphAttributes.color!==void 0,d=o.morphAttributes.position||[],b=o.morphAttributes.normal||[],E=o.morphAttributes.color||[];let S=0;g===!0&&(S=1),_===!0&&(S=2),p===!0&&(S=3);let U=o.attributes.position.count*S,w=1;U>e.maxTextureSize&&(w=Math.ceil(U/e.maxTextureSize),U=e.maxTextureSize);const R=new Float32Array(U*w*4*h),I=new sl(R,U,w,h);I.type=en,I.needsUpdate=!0;const y=S*4;for(let A=0;A<h;A++){const G=d[A],z=b[A],$=E[A],K=U*w*4*A;for(let X=0;X<G.count;X++){const j=X*y;g===!0&&(r.fromBufferAttribute(G,X),R[K+j+0]=r.x,R[K+j+1]=r.y,R[K+j+2]=r.z,R[K+j+3]=0),_===!0&&(r.fromBufferAttribute(z,X),R[K+j+4]=r.x,R[K+j+5]=r.y,R[K+j+6]=r.z,R[K+j+7]=0),p===!0&&(r.fromBufferAttribute($,X),R[K+j+8]=r.x,R[K+j+9]=r.y,R[K+j+10]=r.z,R[K+j+11]=$.itemSize===4?r.w:1)}}u={count:h,texture:I,size:new Ye(U,w)},i.set(o,u),o.addEventListener("dispose",M)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(n,"morphTexture",a.morphTexture,t);else{let g=0;for(let p=0;p<c.length;p++)g+=c[p];const _=o.morphTargetsRelative?1:1-g;l.getUniforms().setValue(n,"morphTargetBaseInfluence",_),l.getUniforms().setValue(n,"morphTargetInfluences",c)}l.getUniforms().setValue(n,"morphTargetsTexture",u.texture,t),l.getUniforms().setValue(n,"morphTargetsTextureSize",u.size)}return{update:s}}function Xf(n,e,t,i){let r=new WeakMap;function s(l){const c=i.render.frame,f=l.geometry,h=e.get(l,f);if(r.get(h)!==c&&(e.update(h),r.set(h,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),r.get(l)!==c&&(t.update(l.instanceMatrix,n.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,n.ARRAY_BUFFER),r.set(l,c))),l.isSkinnedMesh){const u=l.skeleton;r.get(u)!==c&&(u.update(),r.set(u,c))}return h}function a(){r=new WeakMap}function o(l){const c=l.target;c.removeEventListener("dispose",o),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:s,dispose:a}}class _l extends pt{constructor(e,t,i,r,s,a,o,l,c,f=ai){if(f!==ai&&f!==hi)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");i===void 0&&f===ai&&(i=Bn),i===void 0&&f===hi&&(i=fi),super(null,r,s,a,o,l,f,i,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=o!==void 0?o:Bt,this.minFilter=l!==void 0?l:Bt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const vl=new pt,fo=new _l(1,1),xl=new sl,Ml=new Cc,Sl=new pl,ho=[],po=[],mo=new Float32Array(16),go=new Float32Array(9),_o=new Float32Array(4);function _i(n,e,t){const i=n[0];if(i<=0||i>0)return n;const r=e*t;let s=ho[r];if(s===void 0&&(s=new Float32Array(r),ho[r]=s),e!==0){i.toArray(s,0);for(let a=1,o=0;a!==e;++a)o+=t,n[a].toArray(s,o)}return s}function at(n,e){if(n.length!==e.length)return!1;for(let t=0,i=n.length;t<i;t++)if(n[t]!==e[t])return!1;return!0}function ot(n,e){for(let t=0,i=e.length;t<i;t++)n[t]=e[t]}function Nr(n,e){let t=po[e];t===void 0&&(t=new Int32Array(e),po[e]=t);for(let i=0;i!==e;++i)t[i]=n.allocateTextureUnit();return t}function qf(n,e){const t=this.cache;t[0]!==e&&(n.uniform1f(this.addr,e),t[0]=e)}function Yf(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(at(t,e))return;n.uniform2fv(this.addr,e),ot(t,e)}}function $f(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(at(t,e))return;n.uniform3fv(this.addr,e),ot(t,e)}}function Kf(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(at(t,e))return;n.uniform4fv(this.addr,e),ot(t,e)}}function Zf(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(at(t,e))return;n.uniformMatrix2fv(this.addr,!1,e),ot(t,e)}else{if(at(t,i))return;_o.set(i),n.uniformMatrix2fv(this.addr,!1,_o),ot(t,i)}}function jf(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(at(t,e))return;n.uniformMatrix3fv(this.addr,!1,e),ot(t,e)}else{if(at(t,i))return;go.set(i),n.uniformMatrix3fv(this.addr,!1,go),ot(t,i)}}function Jf(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(at(t,e))return;n.uniformMatrix4fv(this.addr,!1,e),ot(t,e)}else{if(at(t,i))return;mo.set(i),n.uniformMatrix4fv(this.addr,!1,mo),ot(t,i)}}function Qf(n,e){const t=this.cache;t[0]!==e&&(n.uniform1i(this.addr,e),t[0]=e)}function eh(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(at(t,e))return;n.uniform2iv(this.addr,e),ot(t,e)}}function th(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(at(t,e))return;n.uniform3iv(this.addr,e),ot(t,e)}}function nh(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(at(t,e))return;n.uniform4iv(this.addr,e),ot(t,e)}}function ih(n,e){const t=this.cache;t[0]!==e&&(n.uniform1ui(this.addr,e),t[0]=e)}function rh(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(at(t,e))return;n.uniform2uiv(this.addr,e),ot(t,e)}}function sh(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(at(t,e))return;n.uniform3uiv(this.addr,e),ot(t,e)}}function ah(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(at(t,e))return;n.uniform4uiv(this.addr,e),ot(t,e)}}function oh(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r);let s;this.type===n.SAMPLER_2D_SHADOW?(fo.compareFunction=nl,s=fo):s=vl,t.setTexture2D(e||s,r)}function lh(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture3D(e||Ml,r)}function ch(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTextureCube(e||Sl,r)}function dh(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture2DArray(e||xl,r)}function uh(n){switch(n){case 5126:return qf;case 35664:return Yf;case 35665:return $f;case 35666:return Kf;case 35674:return Zf;case 35675:return jf;case 35676:return Jf;case 5124:case 35670:return Qf;case 35667:case 35671:return eh;case 35668:case 35672:return th;case 35669:case 35673:return nh;case 5125:return ih;case 36294:return rh;case 36295:return sh;case 36296:return ah;case 35678:case 36198:case 36298:case 36306:case 35682:return oh;case 35679:case 36299:case 36307:return lh;case 35680:case 36300:case 36308:case 36293:return ch;case 36289:case 36303:case 36311:case 36292:return dh}}function fh(n,e){n.uniform1fv(this.addr,e)}function hh(n,e){const t=_i(e,this.size,2);n.uniform2fv(this.addr,t)}function ph(n,e){const t=_i(e,this.size,3);n.uniform3fv(this.addr,t)}function mh(n,e){const t=_i(e,this.size,4);n.uniform4fv(this.addr,t)}function gh(n,e){const t=_i(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,t)}function _h(n,e){const t=_i(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,t)}function vh(n,e){const t=_i(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,t)}function xh(n,e){n.uniform1iv(this.addr,e)}function Mh(n,e){n.uniform2iv(this.addr,e)}function Sh(n,e){n.uniform3iv(this.addr,e)}function Eh(n,e){n.uniform4iv(this.addr,e)}function yh(n,e){n.uniform1uiv(this.addr,e)}function Th(n,e){n.uniform2uiv(this.addr,e)}function bh(n,e){n.uniform3uiv(this.addr,e)}function Ah(n,e){n.uniform4uiv(this.addr,e)}function wh(n,e,t){const i=this.cache,r=e.length,s=Nr(t,r);at(i,s)||(n.uniform1iv(this.addr,s),ot(i,s));for(let a=0;a!==r;++a)t.setTexture2D(e[a]||vl,s[a])}function Rh(n,e,t){const i=this.cache,r=e.length,s=Nr(t,r);at(i,s)||(n.uniform1iv(this.addr,s),ot(i,s));for(let a=0;a!==r;++a)t.setTexture3D(e[a]||Ml,s[a])}function Ch(n,e,t){const i=this.cache,r=e.length,s=Nr(t,r);at(i,s)||(n.uniform1iv(this.addr,s),ot(i,s));for(let a=0;a!==r;++a)t.setTextureCube(e[a]||Sl,s[a])}function Ph(n,e,t){const i=this.cache,r=e.length,s=Nr(t,r);at(i,s)||(n.uniform1iv(this.addr,s),ot(i,s));for(let a=0;a!==r;++a)t.setTexture2DArray(e[a]||xl,s[a])}function Lh(n){switch(n){case 5126:return fh;case 35664:return hh;case 35665:return ph;case 35666:return mh;case 35674:return gh;case 35675:return _h;case 35676:return vh;case 5124:case 35670:return xh;case 35667:case 35671:return Mh;case 35668:case 35672:return Sh;case 35669:case 35673:return Eh;case 5125:return yh;case 36294:return Th;case 36295:return bh;case 36296:return Ah;case 35678:case 36198:case 36298:case 36306:case 35682:return wh;case 35679:case 36299:case 36307:return Rh;case 35680:case 36300:case 36308:case 36293:return Ch;case 36289:case 36303:case 36311:case 36292:return Ph}}class Dh{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.setValue=uh(t.type)}}class Ih{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Lh(t.type)}}class Uh{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){const r=this.seq;for(let s=0,a=r.length;s!==a;++s){const o=r[s];o.setValue(e,t[o.id],i)}}}const us=/(\w+)(\])?(\[|\.)?/g;function vo(n,e){n.seq.push(e),n.map[e.id]=e}function Nh(n,e,t){const i=n.name,r=i.length;for(us.lastIndex=0;;){const s=us.exec(i),a=us.lastIndex;let o=s[1];const l=s[2]==="]",c=s[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===r){vo(t,c===void 0?new Dh(o,n,e):new Ih(o,n,e));break}else{let h=t.map[o];h===void 0&&(h=new Uh(o),vo(t,h)),t=h}}}class Mr{constructor(e,t){this.seq=[],this.map={};const i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<i;++r){const s=e.getActiveUniform(t,r),a=e.getUniformLocation(t,s.name);Nh(s,a,this)}}setValue(e,t,i,r){const s=this.map[t];s!==void 0&&s.setValue(e,i,r)}setOptional(e,t,i){const r=t[i];r!==void 0&&this.setValue(e,i,r)}static upload(e,t,i,r){for(let s=0,a=t.length;s!==a;++s){const o=t[s],l=i[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,r)}}static seqWithValue(e,t){const i=[];for(let r=0,s=e.length;r!==s;++r){const a=e[r];a.id in t&&i.push(a)}return i}}function xo(n,e,t){const i=n.createShader(e);return n.shaderSource(i,t),n.compileShader(i),i}const Fh=37297;let Oh=0;function Bh(n,e){const t=n.split(`
`),i=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let a=r;a<s;a++){const o=a+1;i.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return i.join(`
`)}const Mo=new Ce;function zh(n){ze._getMatrix(Mo,ze.workingColorSpace,n);const e=`mat3( ${Mo.elements.map(t=>t.toFixed(4))} )`;switch(ze.getTransfer(n)){case Dr:return[e,"LinearTransferOETF"];case qe:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",n),[e,"LinearTransferOETF"]}}function So(n,e,t){const i=n.getShaderParameter(e,n.COMPILE_STATUS),r=n.getShaderInfoLog(e).trim();if(i&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const a=parseInt(s[1]);return t.toUpperCase()+`

`+r+`

`+Bh(n.getShaderSource(e),a)}else return r}function Hh(n,e){const t=zh(e);return[`vec4 ${n}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function kh(n,e){let t;switch(e){case tc:t="Linear";break;case nc:t="Reinhard";break;case ic:t="Cineon";break;case rc:t="ACESFilmic";break;case ac:t="AgX";break;case oc:t="Neutral";break;case sc:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const ur=new F;function Gh(){ze.getLuminanceCoefficients(ur);const n=ur.x.toFixed(4),e=ur.y.toFixed(4),t=ur.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function Vh(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",n.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Ri).join(`
`)}function Wh(n){const e=[];for(const t in n){const i=n[t];i!==!1&&e.push("#define "+t+" "+i)}return e.join(`
`)}function Xh(n,e){const t={},i=n.getProgramParameter(e,n.ACTIVE_ATTRIBUTES);for(let r=0;r<i;r++){const s=n.getActiveAttrib(e,r),a=s.name;let o=1;s.type===n.FLOAT_MAT2&&(o=2),s.type===n.FLOAT_MAT3&&(o=3),s.type===n.FLOAT_MAT4&&(o=4),t[a]={type:s.type,location:n.getAttribLocation(e,a),locationSize:o}}return t}function Ri(n){return n!==""}function Eo(n,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return n.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function yo(n,e){return n.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const qh=/^[ \t]*#include +<([\w\d./]+)>/gm;function aa(n){return n.replace(qh,$h)}const Yh=new Map;function $h(n,e){let t=Le[e];if(t===void 0){const i=Yh.get(e);if(i!==void 0)t=Le[i],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,i);else throw new Error("Can not resolve #include <"+e+">")}return aa(t)}const Kh=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function To(n){return n.replace(Kh,Zh)}function Zh(n,e,t,i){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=i.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function bo(n){let e=`precision ${n.precision} float;
...
#define LOW_PRECISION`),e}function jh(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===Vo?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===Ul?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===Jt&&(e="SHADOWMAP_TYPE_VSM"),e}function Jh(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case di:case ui:e="ENVMAP_TYPE_CUBE";break;case Lr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Qh(n){let e="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case ui:e="ENVMAP_MODE_REFRACTION";break}return e}function ep(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case Wo:e="ENVMAP_BLENDING_MULTIPLY";break;case Ql:e="ENVMAP_BLENDING_MIX";break;case ec:e="ENVMAP_BLENDING_ADD";break}return e}function tp(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:i,maxMip:t}}function np(n,e,t,i){const r=n.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=jh(t),c=Jh(t),f=Qh(t),h=ep(t),u=tp(t),m=Vh(t),g=Wh(s),_=r.createProgram();let p,d,b=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
  ...
  `,n.isName&&(e.style.backgroundColor="transparent"),e}function Jp(n){const e=document.createElement("div");return e.className="project-label",e.dataset.key=n.key,e.innerHTML=`
  ...
  `,e}function Qp(n){const e=new Ci,t=new on;t.setAttribute("position",new zt(ms(Xp,ps),3));const i=new El({size:.18,map:Zp(),blending:xs,depthWrite:!1,transparent:!0,color:new Ve(.133,.773,.369),opacity:.75,sizeAttenuation:!0}),r=new Op(t,i);e.add(r);const s=new Float32Array(t.attributes.position.array),a=t.attributes.position.array,o=[];let l=null;Kp.forEach(g=>{const _=jp(g),p=new hs(_);p.position.set(g.x,g.y,g.z),e.add(p),o.push({obj:p,el:_,data:g}),g.isName&&(l={obj:p,el:_,data:g})});const c=ms(Fo.length,ps*1.04),f=[];Fo.forEach((g,_)=>{const p=document.createElement("span");p.textContent=g.text,p.style.cssText=`
      font-family: 'Space Mono', 'Courier New', monospace;
    ...
    `;const d=new hs(p);d.position.set(c[_*3],c[_*3+1],c[_*3+2]),e.add(d),f.push({obj:d,el:p,data:g})});const h=null,u=ms(Oo.length,ps*1.02),m=[];return Oo.forEach((g,_)=>{const p=Jp(g),d=new hs(p);d.position.set(u[_*3],u[_*3+1],u[_*3+2]),e.add(d),m.push({obj:d,el:p,data:g,idx:_})}),n.add(e),{group:e,particles:r,particleMat:i,particleGeo:t,origPos:s,particlePos:a,nodeRefs:m,infoRefs:o,nameRef:l,nameFixedEl:h,tagRefs:f,velocities:null,targets:null,exploding:!1,explosionProgress:0}}function em(n,e){if(Sn()!==Xe.IDLE)return;Gp(e,.055),n._autoRotY=(n._autoRotY||0)+qp,n._wobbleX=(n._wobbleX||0)+Math.sin(Date.now()*3e-4)*15e-5,n.group.rotation.y=n._autoRotY+e.currentX*.08,n.group.rotation.x=n._wobbleX+e.currentY*.08;const t=1+Math.sin(Date.now()*$p*.001)*Yp;n.group.scale.setScalar(t),n.particleMat.opacity=.6+Math.sin(Date.now()*.0015)*.15}function tm(){const n=document.getElementById("status-bar");n&&(n.innerHTML=`
...
● 交付成果
→ 实现智能决策闭环，用户点击红色盲区节点可自动触发混合检索并捞取外部趋势。`},a2:{title:"RARE 逆向资产与智能评估",path:"~/projects/rare",tag:"AI4SE · 逆向工程",metrics:["元数据逆向解析","嵌套交互画布","LLM智能评估"],video:"./rare-video.mp4",content:`● 项目定位
...
● 交付成果
→ 构建了可视化的嵌套交互画布，打破代码黑盒。`},b1:{title:"科技管理应用",path:"~/projects/tech-mgmt",tag:"B端 · 国网信通",metrics:["跨部门协同","流程解构","资产纳管"],video:"./tech-mgmt.mp4",content:`● 项目定位
...
● 交付成果
→ 纳管科研项目 2087 项、科研成果 17805 项。全流程 100% 线上化，评定周期缩短 40%，效率提升 60%+。荣获 2021 电力科技管理创新成果一等奖。`},b2:{title:"巡查问题在线管理",path:"~/projects/patrol",tag:"B端 · 合规治理",metrics:["合规双审","人才分配","全流程留痕"],video:"./project-b2.mp4",content:`● 项目定位
...
● 交付成果
→ 独立编制全套规范材料，成功支撑巡察问题数字化管理系统在多级单位间的协同运转。`},b3:{title:"项目管理应用",path:"~/projects/project-mgmt",tag:"B端 · 全生命周期",metrics:["业务解构","权限划分","多模块集成"],video:"./project-mgmt.mp4",content:`● 项目定位
...
● 核心突破
→ 复杂业务解构：负责全类型项目分摊与跨项目报工、阶段性劳务报工管理、经营性项目关联研发项目等相关需求梳理与方案产出，涉及现有系统逻辑重构。`}};let Ft=null,Ar=!1;function nm(n){if(Ar){wr();return}const t=Bo[{a1:"a1",a2:"a2",b1:"b1",b2:"b2",b3:"b3"}[n]]||Bo.a1;im(),rm(t),document.body.style.overflow="hidden",Ft.classList.add("active"),Ar=!0}function wr(){!Ft||!Ar||(Ft.classList.remove("active"),Ar=!1,document.body.style.overflow="")}function im(){if(Ft){Ft.innerHTML="";return}Ft=document.createElement("div"),Ft.id="terminal-overlay",document.body.appendChild(Ft)}function rm(n){Ft.innerHTML=`
    <!-- backdrop -->
  ...
  `,Ft.querySelector("#tt-close").addEventListener("click",wr),Ft.querySelector(".tt-backdrop").addEventListener("click",wr)}function sm(n){return n.split(`
`).map(t=>{const i=t.trim();return i?i.startsWith("【")?`<div class="cl-section"><span class="cl-dot">●</span> ${bi(i.replace(/[【】]/g,""))}</div>`:i.startsWith("●")?`<div class="cl-section"><span class="cl-dot">●</span> ${bi(i.slice(1).trim())}</div>`:i.startsWith("→")?`<div class="cl-bullet"><span class="cl-arrow">→</span>${bi(i.slice(1).trim())}</div>`:/\d+%/.test(i)||/\d+ 项/.test(i)||/^\d+/.test(i)?`<div class="cl-highlight">${bi(i)}</div>`:`<div class="cl-line">${bi(i)}</div>`:'<div class="cl-empty"></div>'}).join("")}function bi(n){return n.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}let Gt=null;const am={b1:{name:"科技管理应用",tag:"B端·科技管理"},b2:{name:"巡查问题在线管理",tag:"B端·合规治理"},b3:{name:"项目管理应用",tag:"B端·全生命周期"}};function yl(n){const e=document.getElementById("sim-rare-overlay");e&&e.remove(),Gt=null;const t=am[n]||{name:"未知项目"};Gt=document.createElement("div"),Gt.id="sim-rare-overlay",Gt.innerHTML=`
    ...
    <div class="sr-window">
      ...
      <div class="sr-body" id="sr-body" style="display:none">
        <iframe class="sr-iframe" id="sr-iframe" src="./rare/index.html?project=${n}&_t=${Date.now()}" loading="eager"></iframe>
      </div>
    </div>
  `,document.body.appendChild(Gt),Gt.classList.add("active"),document.getElementById("sr-close").addEventListener("click",zo),document.getElementById("sr-backdrop").addEventListener("click",zo),document.getElementById("sr-iframe").addEventListener("load",o=>{var l;try{const c=o.target.contentDocument||((l=o.target.contentWindow)==null?void 0:l.document);if(!c)return;const f=c.createElement("style"),h=new URL(c.location.href).searchParams.get("redirect")==="1";if(f.textContent=`
        /* Hide save/confirm/asset management buttons */
        button:has(span) { } /* placeholder */
      `,c.head.appendChild(f),h){let g=c.getElementById("sr-redirect-overlay");if(g||(g=c.createElement("div"),g.id="sr-redirect-overlay",c.body.appendChild(g)),g.style.cssText="position:fixed;inset:0;z-index:99999;background:#0a0a0a;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;color:rgba(255,255,255,0.3);font-size:13px;font-family:inherit",g.innerHTML='<div style="width:200px;height:4px;background:rgba(255,255,255,0.06);border-radius:4px;overflow:hidden"><div style="width:30%;height:100%;background:linear-gradient(90deg,rgba(34,197,94,0.3),rgba(34,197,94,0.7));border-radius:4px;animation:srBar 1.4s ease-in-out infinite"></div></div><span>正在加载智能评估…</span>',!c.getElementById("sr-bar-style")){const _=c.createElement("style");_.id="sr-bar-style",_.textContent="@keyframes srBar{0%{transform:translateX(-100%)}50%{transform:translateX(200%)}100%{transform:translateX(200%)}}",c.head.appendChild(_)}}let u=!1;const m=setInterval(()=>{if(!c.body){clearInterval(m);return}c.querySelectorAll("button").forEach(E=>{const S=(E.textContent||"").trim();(S.includes("保存")||S.includes("确认")||S.includes("资产管理")||S.includes("上传")||S.includes("Upload")||S==="编辑")&&(E.style.display="none")});const g=c.querySelector(".react-flow__viewport");if(g){const E=g.style.transform.match(/scale\(([\d.]+)\)/),S=E?parseFloat(E[1]):1,U=Math.round(13/Math.max(S,.1));let w=c.getElementById("rf-zoom-style");w||(w=c.createElement("style"),w.id="rf-zoom-style",c.head.appendChild(w)),w.textContent=`.react-flow__node *[style*="font-size"] { font-size: ${Math.max(U,10)}px !important }`}c.querySelectorAll("button").forEach(E=>{(E.textContent.includes("精炼")||E.textContent.includes("优化")||E.textContent.includes("评估"))&&!E.dataset._optFixed&&(E.dataset._optFixed="1",E.removeAttribute("disabled"),Object.defineProperty(E,"disabled",{get:()=>!1,configurable:!0}),E.addEventListener("click",()=>{const S=c.querySelector("textarea");S&&(S.value=S.value||"1】测试需求",S.dispatchEvent(new Event("input",{bubbles:!0})))},{once:!0}))});const _=c.defaultView,p=c.querySelector('[class*="version" i]')||Array.from(c.querySelectorAll("div")).find(E=>E.textContent.includes("版本管理")&&E.children.length>3);p&&_&&(p.dataset._srCapture||(p.dataset._srCapture="1",p.addEventListener("click",E=>{let S=E.target;for(;S&&S.parentElement!==p;)S=S.parentElement;if(!S)return;const U=(S.textContent||"").match(/[vV](\d+)/);U&&(_._srSelectedVersion=parseInt(U[1]))},!0)));const d=_&&_._srCommits,b=Array.from(c.querySelectorAll("button")).find(E=>(E.textContent||"").trim()==="退出预览");if(b&&d&&d.length>0){const E=_._srSelectedVersion||(d.length>0?d[d.length-1].version:null),S=E?d.find(U=>U.version===E):null;b.textContent="↩ 回退",b.style.cssText="padding:4px 10px;border:none;border-radius:6px;background:rgba(239,68,68,0.15);color:#ef4444;cursor:pointer;font-size:11px;font-weight:600;font-family:inherit",b.dataset._srRbfixed||(b.dataset._srRbfixed="1",b.addEventListener("click",U=>{U.stopPropagation(),U.preventDefault();const w=S||d[d.length-1];if(!w)return;const R=w.version||0,I=c.querySelector(".sr-confirm-dialog");I&&I.remove();const y=c.createElement("div");y.className="sr-confirm-dialog",y.style.cssText="position:fixed;inset:0;z-index:999;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,0.5)",y.innerHTML='<div style="background:#1a1a1a;border:1px solid rgba(255,255,255,0.1);border-radius:12px;padding:24px;max-width:360px;text-align:center"><div style="font-size:14px;color:#e0e0e0;margin-bottom:16px">是否进行回退操作？<br><span style="font-size:12px;color:rgba(255,255,255,0.4)">回退后将删除画布上该次评估生成的新增实体</span></div><div style="display:flex;gap:10px;justify-content:center"><button id="sr-confirm-yes" style="padding:8px 24px;border:none;border-radius:8px;background:rgba(239,68,68,0.2);color:#ef4444;cursor:pointer;font-size:13px;font-weight:600;font-family:inherit">是，回退</button><button id="sr-confirm-no" style="padding:8px 24px;border:none;border-radius:8px;background:rgba(255,255,255,0.05);color:rgba(255,255,255,0.5);cursor:pointer;font-size:13px;font-family:inherit">取消</button></div></div>',c.body.appendChild(y),c.getElementById("sr-confirm-yes").onclick=()=>{y.remove(),_&&_.fullProject&&(w._entities&&(_.fullProject.fields=_.fullProject.fields.filter(G=>!w._entities.includes(G.id))),w._edges&&(_.fullProject.edges=_.fullProject.edges.filter(G=>!w._edges.includes(G.id))));const M=d.findIndex(G=>G.version===R);M>=0&&d.splice(M,1);const A=new URL(c.location.href).searchParams.get("project")||"b2";c.location.href=c.location.href.split("?")[0]+"?project="+A+"&_t="+Date.now()+"&redirect=1"},c.getElementById("sr-confirm-no").onclick=()=>y.remove()}))}if(c.querySelectorAll("span").forEach(E=>{var S;!((S=E.children)!=null&&S.length)&&(E.textContent||"").includes("Space")&&(E.textContent||"").includes("拖拽")&&(E.style.display="none")}),u||c.querySelectorAll('button, [role="button"], [style*="cursor"]').forEach(E=>{if((E.textContent||"").trim().includes("智能评估")){E.click(),u=!0;const S=c.getElementById("sr-redirect-overlay");S&&S.remove()}}),h&&u){const E=c.getElementById("sr-redirect-overlay");E&&E.remove()}c.querySelectorAll("textarea").forEach(E=>{if(!E.parentNode||E.dataset._replaced)return;E.dataset._replaced="1";const S=E.parentNode.querySelector(".sr-chip-container");S&&S.remove();const U=c.createElement("div");U.className="sr-chip-container",U.style.cssText="flex:1;display:flex;flex-direction:column;gap:6px";const w=c.createElement("input");w.readOnly=!0,w.placeholder="选择需求类型",w.style.cssText="width:100%;padding:12px 16px;font-size:13px;color:#e0e0e0;background:transparent;border:none;border-radius:8px;outline:none;font-family:inherit;box-sizing:border-box;cursor:pointer",w.addEventListener("focus",()=>{w.style.borderColor="rgba(34,197,94,0.5)"}),w.addEventListener("blur",()=>{w.style.borderColor="rgba(34,197,94,0.2)"}),U.appendChild(w);const R=c.createElement("div");R.style.cssText="display:flex;gap:6px;flex-wrap:wrap";const I=new URL(c.location.href).searchParams.get("project")||"";(I==="b1"?["进度管理页面新增一个里程碑状态","科技成果模块新增一个成果库页面"]:I==="b2"?["人才基本信息页面新增一个上传简历功能","组队选才页面新增角色要求功能"]:I==="b3"?["成员管理里新增一个人员报工功能"]:["新增模块","进度管理页面新增一个里程碑状态","变更流程"]).forEach(M=>{const A=c.createElement("span");A.textContent=M,A.style.cssText="padding:5px 14px;border-radius:6px;font-size:11px;cursor:pointer;background:rgba(34,197,94,0.06);border:1px solid rgba(34,197,94,0.15);color:rgba(34,197,94,0.7);transition:all 0.2s;font-family:inherit",A.addEventListener("mouseenter",()=>{A.style.background="rgba(34,197,94,0.15)",A.style.borderColor="rgba(34,197,94,0.3)",A.style.color="#22c55e"}),A.addEventListener("mouseleave",()=>{A.style.background="rgba(34,197,94,0.06)",A.style.borderColor="rgba(34,197,94,0.15)",A.style.color="rgba(34,197,94,0.7)"}),A.addEventListener("click",()=>{w.value=M;const G=Object.getOwnPropertyDescriptor(window.HTMLTextAreaElement.prototype,"value");G?(G.set.call(E,M),E.dispatchEvent(new Event("input",{bubbles:!0}))):(E.value=M,E.dispatchEvent(new Event("input",{bubbles:!0})))}),R.appendChild(A)}),U.appendChild(R),E.style.display="none",E.parentNode.insertBefore(U,E.nextSibling)})},500)}catch{}});let i=0;const r=document.getElementById("sr-loader-fill"),s=document.getElementById("sr-loader-pct"),a=setInterval(()=>{i+=Math.random()*12+3,i>100&&(i=100,clearInterval(a)),r&&(r.style.width=i+"%"),s&&(s.textContent=Math.round(i)+"%"),i>=100&&setTimeout(()=>{document.getElementById("sr-loader").style.display="none",document.getElementById("sr-body").style.display="flex"},300)},180)}function zo(){Gt&&(window.dispatchEvent(new CustomEvent("close-sim-rare")),Gt.classList.remove("active"),setTimeout(()=>{Gt.remove(),Gt=null},400))}const om={"b1→a1":!0,"b1→a2":!0,"b2→a1":!0,"b2→a2":!0,"b3→a1":!0,"b3→a2":!0,"b3→b1":!0,"b3→b2":!0};function ca(n,e){return n===e?!1:om[`${n}→${e}`]===!0}let Di=null,li=null,Wt=[],Hn=!1,vt=null,ct=null,gs=0;function lm(){if(Di)return Di;const n=document.createElementNS("http://www.w3.org/2000/svg","svg");return n.style.cssText="position:fixed;inset:0;width:100%;height:100%;pointer-events:none;z-index:15",document.body.appendChild(n),Di=n,n}function da(n,e,t=.5,i=2){const r=document.createElementNS("http://www.w3.org/2000/svg","path");return r.setAttribute("stroke",e),r.setAttribute("stroke-width",String(i)),r.setAttribute("fill","none"),r.setAttribute("stroke-linejoin","round"),r.setAttribute("stroke-linecap","round"),r.setAttribute("opacity",String(t)),n&&r.classList.add(n),lm().appendChild(r),r}function ya(n,e,t,i){const r=Math.abs(t-n)*.4;return`M ${n} ${e} C ${n+r} ${e} ${t-r} ${i} ${t} ${i}`}function ri(n){const e=document.querySelector(`.project-label.card[data-key="${n}"]`);if(!e)return null;const t=e.getBoundingClientRect();return{left:{x:t.left-8,y:t.top+t.height/2},right:{x:t.right+8,y:t.top+t.height/2}}}function Rr(n){["a1","a2"].forEach(t=>{const i=document.querySelector(`.project-label.card[data-key="${t}"]`);if(!i)return;const r=i.querySelector(".endpoint.left");r&&r.classList.toggle("pulse",n)})}function cm(n,e,t){Sn()===Xe.FLOATING&&(Hn=!0,vt={key:n,sx:e,sy:t},ct=null,li=da("drag-line","rgba(34,197,94,0.5)",.6,2),["b1","b2","b3"].includes(n)&&Rr(!0))}function dm(n,e,t){Hn&&(ct={key:n,sx:e,sy:t})}function um(){Hn&&(ct=null)}document.addEventListener("mousemove",n=>{if(!Hn||!vt)return;const e=ct||{sx:n.clientX,sy:n.clientY};li.setAttribute("d",ya(vt.sx,vt.sy,e.sx,e.sy))});document.addEventListener("mouseup",()=>{if(Hn){if(Hn=!1,console.log("🐭 mouseup dragFrom:",vt==null?void 0:vt.key,"dragTo:",ct==null?void 0:ct.key,"valid:",ct?ca(vt.key,ct.key):"no-target"),ct&&ca(vt.key,ct.key))Tl(vt,ct);else if(ct){const n=(vt.sx+ct.sx)/2,e=(vt.sy+ct.sy)/2;bl(n,e)}Rr(!1),li&&(li.remove(),li=null),vt=null,ct=null}});function Tl(n,e){const t=da("conn-line","#22c55e",.4,2),i=da("conn-glow","#22c55e",.08,6),r=ya(n.sx,n.sy,e.sx,e.sy);t.setAttribute("d",r),i.setAttribute("d",r);const s={fromKey:n.key,toKey:e.key,fromSx:n.sx,fromSy:n.sy,toSx:e.sx,toSy:e.sy,path:t,glow:i,_flowTime:Math.random()*100};if(Wt.push(s),Rr(!1),e.key==="a2"&&["b1","b2","b3"].includes(n.key))console.log("🎯 triggering sim-rare for",n.key),setTimeout(()=>yl(n.key),300);else if(e.key==="a1"&&["b1","b2","b3"].includes(n.key)){console.log("🎆 OmniSight connection — showing teaser"),fm((n.sx+e.sx)/2,(n.sy+e.sy)/2),Rr(!1),t&&t.remove(),i&&i.remove();const a=Wt.indexOf(s);a!==-1&&Wt.splice(a,1);return}else console.log("❌ sim-rare NOT triggered: to=",e.key,"from=",n.key);console.log(`%c🔗  ${n.key} → ${e.key} — VALID`,"color:#22c55e;font-family:monospace"),hm()}function bl(n,e){const t=document.createElement("div");t.style.cssText=`position:fixed;left:${n}px;top:${e}px;width:4px;height:4px;border-radius:50%;background:#FF5500;pointer-events:none;z-index:20;box-shadow:0 0 6px #FF5500`,document.body.appendChild(t),t.animate([{transform:"scale(0)",opacity:1},{transform:"scale(8)",opacity:0}],{duration:600,easing:"ease-out"}).onfinish=()=>t.remove(),console.log("%c🔥  [Schema Error]: Matrix Mismatch","color:#FF5500;font-size:13px;font-weight:bold;font-family:monospace")}function fm(n,e){const t=["#FF6B6B","#FFE66D","#4ECDC4","#45B7D1","#96CEB4","#FF69B4","#FFD700","#7B68EE"];for(let r=0;r<60;r++){const s=document.createElement("div"),a=Math.PI*2*r/60+(Math.random()-.5)*.3,o=150+Math.random()*320,l=Math.cos(a)*o,c=Math.sin(a)*o,f=5+Math.random()*10,h=t[Math.floor(Math.random()*t.length)];s.style.cssText=`position:fixed;left:${n}px;top:${e}px;width:${f}px;height:${f}px;border-radius:50%;background:${h};pointer-events:none;z-index:20;box-shadow:0 0 ${f+2}px ${h}`,document.body.appendChild(s),s.animate([{transform:"translate(0,0) scale(0)",opacity:1},{transform:`translate(${l}px,${c}px) scale(1)`,opacity:1,offset:.5},{transform:`translate(${l*1.2}px,${c*1.2}px) scale(0.3)`,opacity:0}],{duration:1200,easing:"ease-out"}).onfinish=()=>s.remove()}const i=document.createElement("div");i.style.cssText=`position:fixed;left:${n}px;top:${e-30}px;transform:translate(-50%,-50%);color:white;font-size:28px;font-weight:700;font-family:'Space Mono',monospace;pointer-events:none;z-index:21;text-shadow:0 0 20px rgba(255,255,255,0.5),0 0 40px rgba(255,255,255,0.3);letter-spacing:4px`,i.textContent="✨ 敬请期待！ ✨",document.body.appendChild(i),i.animate([{transform:"translate(-50%,-50%) scale(0)",opacity:0},{transform:"translate(-50%,-50%) scale(1.2)",opacity:1,offset:.3},{transform:"translate(-50%,-50%) scale(1)",opacity:1,offset:.6},{transform:"translate(-50%,-60%) scale(0.9)",opacity:0}],{duration:2500,easing:"ease-out"}).onfinish=()=>i.remove()}function hm(){const n=new Set;Wt.forEach(e=>{n.add(e.fromKey),n.add(e.toKey)}),n.size>=3&&!window.__safariTriggered&&(window.__safariTriggered=!0,document.dispatchEvent(new CustomEvent("connections-ready")))}function pm(){Wt.length!==0&&(gs+=.05,Wt.forEach((n,e)=>{const t=(Math.sin(gs+e)*4+8).toFixed(0);n.path.setAttribute("stroke-dasharray",`${t} ${16-t}`),n.path.setAttribute("stroke-dashoffset",String(-gs*3));const i=ri(n.fromKey),r=ri(n.toKey);if(i&&r){const s=ya(i.right.x,i.right.y,r.left.x,r.left.y);s!==n.path.getAttribute("d")&&(n.path.setAttribute("d",s),n.glow.setAttribute("d",s))}}))}function mm(n,e){if(!(ri(n)&&ri(e)))return;const i=ri(n).right,r=ri(e).left;ca(n,e)?Tl({key:n,sx:i.x,sy:i.y},{key:e,sx:r.x,sy:r.y}):bl((i.x+r.x)/2,(i.y+r.y)/2)}window.__testConnection=(n,e)=>e==="a2"&&["b1","b2","b3"].includes(n)?(yl(n),"sim-rare triggered directly"):mm(n,e);window.addEventListener("close-sim-rare",()=>{const n=Wt.findIndex(e=>e.toKey==="a2"&&["b1","b2","b3"].includes(e.fromKey));if(n!==-1){const e=Wt[n];e.path&&e.path.remove(),e.glow&&e.glow.remove(),Wt.splice(n,1)}window.__safariTriggered=!1});function gm(){Di&&(Di.innerHTML=""),Wt=[],li=null,vt=null,ct=null,Hn=!1,window.__safariTriggered=!1}const Ai=64,Sr=1e3,Al=1200,_m=Sr+Al,vm=50;let ua=!1;function xm(n,e){const t=new Float32Array(n*3),i=(1+Math.sqrt(5))/2;for(let r=0;r<n;r++){const s=1-r/(n-1)*2,a=Math.sqrt(1-s*s),o=2*Math.PI*r*i;t[r*3]=a*Math.cos(o)*e,t[r*3+1]=s*e,t[r*3+2]=a*Math.sin(o)*e}return t}function Mm(n){return n<=0?0:n>=1?1:1-Math.pow(1-n,2.5)}function Sm(n){return 1-Math.pow(1-n,3)}function Em(n,e,t){let i=null;const r=280;return document.addEventListener("click",()=>{if(Sn()===Xe.IDLE){if(i){clearTimeout(i),i=null,_s(n,e,t);return}i=setTimeout(()=>{i=null},r)}}),window.__triggerExplosion=()=>{Sn()===Xe.IDLE&&_s(n,e,t)},window.addEventListener("keydown",s=>{s.key==="Escape"&&Sn()!==Xe.IDLE&&Ho(e)}),{startExplosion:()=>_s(n,e,t),resetExplosion:()=>Ho(e)}}function _s(n,e,t){if(ua||(ua=!0,!la(Xe.EXPLODE)))return;console.log("%c💥  KERNEL_MODULES DECOUPLING  💥","color: #22c55e; font: bold 14px monospace;");const i=document.getElementById("guide-hint");i&&(i.style.display="none");const r=document.getElementById("system-info");r&&(r.style.display="none"),e.infoRefs.forEach(a=>{a.el.style.transition="opacity 0.5s ease",a.el.style.opacity="0"}),e.tagRefs&&e.tagRefs.forEach(a=>{a.el.style.transition="opacity 0.5s ease",a.el.style.opacity="0"}),e.nameFixedEl&&(e.nameFixedEl.style.opacity="1"),e.group.rotation.x=0,e.group.rotation.y=0,e.group.rotation.z=0,e.group.scale.setScalar(1);const s=e.particlePos.length/3;e.velocities=new Float32Array(s*3),e.targets=new Float32Array(s*3),ym(e,t),Tm(e),e.nodeRefs.forEach(({el:a})=>{a.style.transition="opacity 0.5s ease, transform 0.5s ease",a.style.opacity="0",a.style.transform="scale(0.8)"}),bm(e)}function ym(n,e){const t=n.particlePos,i=t.length/3,r=n.targets,s=window.innerWidth,a=window.innerHeight,o=new F,l=new Map;for(let c=0;c<i;c++){o.set(t[c*3],t[c*3+1],t[c*3+2]),o.project(e);let f=(o.x*.5+.5)*s,h=(-o.y*.5+.5)*a;f=Math.max(0,Math.min(s,f)),h=Math.max(0,Math.min(a,h));let u=Math.round(f/Ai)*Ai,m=Math.round(h/Ai)*Ai;u=Math.max(0,Math.min(s,u)),m=Math.max(0,Math.min(a,m));let g=u,_=m,p=0;for(;l.has(`${g},${_}`)&&p<24;){p++;const E=Math.ceil(p/4)*Ai,S=p%4;S===0?(g=u+E,_=m):S===1?(g=u,_=m+E):S===2?(g=u-E,_=m):(g=u,_=m-E),g=Math.max(0,Math.min(s,g)),_=Math.max(0,Math.min(a,_))}l.set(`${g},${_}`,!0);const d=g/s*2-1,b=-(_/a)*2+1;o.set(d,b,Math.min(o.z,.99)),o.unproject(e),r[c*3]=o.x,r[c*3+1]=o.y,r[c*3+2]=o.z*.3}}function Tm(n){const e=n.particlePos,t=e.length/3,i=n.velocities;for(let r=0;r<t;r++){const s=r*3,a=r*3+1,o=r*3+2,l=Math.sqrt(e[s]**2+e[a]**2+e[o]**2)||1,c=.5+Math.random()*.6;i[s]=e[s]/l*c,i[a]=e[a]/l*c,i[o]=e[o]/l*c}}function bm(n,e){const t=n.particlePos,i=n.velocities,r=n.targets,s=t.length/3,a=performance.now();function o(){const l=performance.now()-a,c=Math.min(l/_m,1);if(l<Sr){const f=l/Sr,h=1-f*.5;for(let u=0;u<s;u++){const m=u*3,g=u*3+1,_=u*3+2;t[m]+=i[m]*h,t[g]+=i[g]*h,t[_]+=i[_]*h}n.particleMat.opacity=.75*(1-f*.2)}else{la(Xe.SETTLE);const f=(l-Sr)/Al,h=Mm(f);for(let u=0;u<s;u++){const m=u*3,g=u*3+1,_=u*3+2;t[m]+=(r[m]-t[m])*h*.15,t[g]+=(r[g]-t[g])*h*.15,t[_]+=(r[_]-t[_])*h*.15}n.particleMat.opacity=Math.max(.2,.6*(1-h*.7)),n.particleMat.size=Math.max(.05,.18*(1-h*.8))}n.particleGeo.attributes.position.needsUpdate=!0,c<1?requestAnimationFrame(o):(n.particleMat.opacity=.2,n.particleMat.size=.05,la(Xe.FLOATING),console.log(`%c◈  Particles adsorbed: ${s}/${s}`,"color: #22c55e; font-family: monospace;"),console.log("%c[Schema Error]: Matrix Mismatch","color: #ef4444; font-family: monospace;"),wm(n))}o()}const Am={a1:["GraphRAG","n8n工作流编排","LLM数据提取"],a2:["元数据逆向解析","多层嵌套交互画布","LLM智能评估"],b1:["跨部门资源协同调度","复杂B端业务流程解构","大规模资产纳管"],b2:["合规化线上双审流程","人才自动分配机制"],b3:["存量功能逻辑重构","多单位权限划分","多模块业务集成"]};function wm(n,e){window.__floatingNodeRefs=n.nodeRefs;const t=n.group;t.rotation.set(0,0,0),t.scale.setScalar(1),t.position.set(0,0,0),n.nodeRefs.forEach(a=>{a.obj.visible=!1});const i=document.getElementById("card-overlay")||(()=>{const a=document.createElement("div");return a.id="card-overlay",a.style.cssText="position:fixed;inset:0;pointer-events:none;z-index:10",document.body.appendChild(a),a})();i.innerHTML="";const r=[[-3,2],[3,2],[0,0],[-3,-2],[3,-2]];new F;const s=n.nodeRefs.map((a,o)=>{const l=a.data.key,[c,f]=r[o%r.length],h=document.createElement("div");h.className="project-label card",h.dataset.key=l,h.style.cssText="pointer-events:auto;position:fixed;opacity:0";const u=!["b1","b2","b3"].includes(l),m=!["a1","a2"].includes(l);h.innerHTML=[u?'<span class="endpoint left" data-key="'+l+'"></span>':"",'<div class="pl-body"><span class="pl-title">'+a.data.label+'</span><span class="pl-desc">'+a.data.desc+"</span></div>",m?'<span class="endpoint right" data-key="'+l+'"></span>':""].join(""),i.appendChild(h);const p=window.innerHeight/2-f*68;return{ref:a,el:h,key:l,bx:c,by:f,_targetY:p,_dragOffsetX:0,_dragOffsetY:0,floatPhase:o/n.nodeRefs.length*Math.PI*2,appeared:!1,bubbles:[],dragging:!1,_pinned:!1}});n._floatingNodes=s,n._floatTime=0,s.forEach((a,o)=>{setTimeout(()=>{const l=a.el,c=a.ref.data.key;if(l.style.top="-180px",l.style.opacity="0",requestAnimationFrame(()=>{l.style.transition="top 0.4s cubic-bezier(0.22, 0.8, 0.15, 1.5), opacity 0.25s ease",l.style.top=a._targetY+"px",l.style.opacity="1"}),a.appeared=!0,l.dataset._listeners)return;l.dataset._listeners="1",l.addEventListener("mouseenter",()=>{a.dragging||(l.classList.add("iridescent"),Cm(a,c),document.querySelectorAll(".project-label.card").forEach(u=>{u!==l&&(u.style.opacity="0.3")}))}),l.addEventListener("mouseleave",()=>{l.classList.remove("iridescent"),Pm(a),document.querySelectorAll(".project-label.card").forEach(u=>{u.style.opacity="1"})}),l.addEventListener("click",u=>{if(!u.target.closest(".endpoint")){if(a._justDragged){a._justDragged=!1;return}a.dragging=!1,u.stopPropagation(),nm(c)}}),l.querySelectorAll(".endpoint").forEach(u=>{u.addEventListener("mousedown",m=>{m.stopPropagation();const g=a.el.getBoundingClientRect(),_=u.classList.contains("right"),p=g.left+(_?g.width+8:-8),d=g.top+g.height/2;cm(c,p,d)}),u.addEventListener("mouseenter",()=>{const m=a.el.getBoundingClientRect(),g=u.classList.contains("right"),_=m.left+(g?m.width+8:-8),p=m.top+m.height/2;dm(c,_,p)}),u.addEventListener("mouseleave",()=>{um()})}),(l.querySelector(".pl-body")||l).addEventListener("mousedown",u=>{if(u.target.closest(".endpoint")||u.target.closest(".bubble"))return;const m=u.clientX,g=u.clientY,_=parseFloat(l.style.left)||0,p=parseFloat(l.style.top)||0;let d=!1;a.dragging=!1;const b=S=>{const U=S.clientX-m,w=S.clientY-g;!d&&(Math.abs(U)>3||Math.abs(w)>3)&&(d=!0,a.dragging=!0,l.style.cursor="grabbing",l.style.transition="none"),d&&(l.style.left=_+U+"px",l.style.top=p+w+"px",l.style.transform="translate(-50%, -50%)",a._pinLeft=_+U,a._pinTop=p+w)},E=()=>{document.removeEventListener("mousemove",b),document.removeEventListener("mouseup",E),d&&(a.dragging=!1,a._pinned=!0,a._justDragged=!0,l.style.cursor="grab",l.style.transition="",setTimeout(()=>{a._justDragged=!1},100))};document.addEventListener("mousemove",b),document.addEventListener("mouseup",E)})},vm*o)}),console.log("%c◈  Nodes scattered: drag enabled, full‑page spread","color: #22c55e; font-family: monospace;")}let gn=null;function Rm(){return gn||(gn=document.createElement("div"),gn.id="bubble-overlay",gn.style.cssText="position:fixed;inset:0;pointer-events:none;z-index:200",document.body.appendChild(gn)),gn}function Cm(n,e){const t=Am[e];if(!t||n.bubbles.length>0)return;const i=Rm(),r=n.el.getBoundingClientRect(),s=r.left+r.width/2,a=r.top+r.height/2,o=80,l=[{left:s,top:a-r.height/2-o,transform:"translateX(-50%)"},{left:s-r.width/2-o,top:a,transform:"translateX(-100%) translateY(-50%)"},{left:s+r.width/2+o,top:a,transform:"translateY(-50%)"}];t.forEach((c,f)=>{const h=document.createElement("div");h.className="bubble",h.textContent=`◈ ${c}`;const u=l[f]||l[0];h.style.left=u.left+"px",h.style.top=u.top+"px",h.style.transform=u.transform,h.style.position="fixed",i.appendChild(h),n.bubbles.push(h),requestAnimationFrame(()=>{setTimeout(()=>h.classList.add("visible"),f*100)})})}function Pm(n){n.bubbles.forEach(e=>{e.classList.remove("visible"),setTimeout(()=>e.remove(),400)}),n.bubbles=[]}function Lm(n,e=16){if(!n._floatingNodes||Sn()!==Xe.FLOATING)return;const t=n._floatingNodes;n._floatTime+=e*.001;const i=n._floatTime,r=window.innerWidth,s=window.innerHeight,a=r/2,o=s/2,l=68;for(const c of t){if(!c.appeared||c.dragging)continue;const f=t.indexOf(c),h=[-3,3,0,-3,3][f]||0,u=[2,2,0,-2,-2][f]||0,m=Math.sin(i*1.2+c.floatPhase)*3;if(c._pinned){const g=Math.sin(i*1.2+c.floatPhase)*2;c._pinLeft!==void 0&&(c.el.style.left=c._pinLeft+"px",c.el.style.top=c._pinTop+"px"),c.el.style.transform="translate(-50%, calc(-50% + "+g+"px))"}else{const g=a+h*l,_=o-u*l;c.el.style.left=g+"px",c.el.style.top=_+m+"px",c.el.style.transform="translate(-50%, -50%)"}}}function Ho(n){if(Sn()===Xe.IDLE)return;console.log("%c⏣  KERNEL_REINTEGRATION: Modules re-engaging…","color: #22c55e; font-family: monospace;");const e=n.particlePos,t=n.origPos,i=e.length/3;n._floatingNodes&&n._floatingNodes.forEach(l=>{l._pinned=!1,l.dragging=!1}),n._floatingNodes=null;const r=xm(n.nodeRefs.length,4.8),s=1500,a=performance.now();function o(){const l=Math.min((performance.now()-a)/s,1),c=Sm(l);for(let f=0;f<i;f++){const h=f*3,u=f*3+1,m=f*3+2;e[h]+=(t[h]-e[h])*c*.12,e[u]+=(t[u]-e[u])*c*.12,e[m]+=(t[m]-e[m])*c*.12}n.particleGeo.attributes.position.needsUpdate=!0,n.particleMat.opacity=.2+l*.55,n.particleMat.size=.05+l*.13,l<1?requestAnimationFrame(o):Dm(n,r)}o()}function Dm(n,e){const t=n.particlePos,i=n.origPos;for(let o=0;o<t.length;o++)t[o]=i[o];n.particleGeo.attributes.position.needsUpdate=!0,wr(),n.nameFixedEl&&(n.nameFixedEl.style.opacity="0"),n.infoRefs.forEach(o=>{o.el.style.opacity="1"}),n.tagRefs&&n.tagRefs.forEach(o=>{o.el.style.opacity="1"}),gn&&(gn.innerHTML="");const r=document.getElementById("card-overlay");r&&r.remove(),n.nodeRefs.forEach((o,l)=>{const c=o.el.querySelector(".pl-body");if(c){const f=c.querySelector(".pl-title"),h=c.querySelector(".pl-desc");f&&(f.textContent=o.data.label),h&&(h.textContent=o.data.desc)}o.el.className="project-label",o.el.style.cssText="",o.obj.visible=!0,o.obj.position.set(e[l*3],e[l*3+1],e[l*3+2])}),n.group.rotation.x=n._wobbleX||0,n.group.rotation.y=n._autoRotY||0,n.group.rotation.z=0,n.group.scale.setScalar(1),n.exploding=!1,n.explosionProgress=0,n.velocities=null,n.targets=null,n._floatingNodes=null,n._floatTime=0,ua=!1;const s=document.getElementById("guide-hint");s&&(s.style.display="");const a=document.getElementById("system-info");a&&(a.style.display=""),Wp(),console.log("%c⏣  KERNEL_REINTEGRATION: Complete — State 01 restored","color: #22c55e; font-family: monospace;")}const Im="https://cdn.jsdelivr.net/npm/@mediapipe/tasks-vision@0.10.18/wasm/vision_bundle.js",Um="https://cdn.jsdelivr.net/npm/@mediapipe/tasks-vision@0.10.18/wasm/",Nm="https://storage.googleapis.com/mediapipe-models/hand_landmarker/hand_landmarker/float16/latest/hand_landmarker.task",Fm=.55,Om=150;let fa=null,Ii=null,Ui=null,ko=0,Cr="CLOSED",Pr=!1,Er=!1;function Rt(n,e){const t=document.getElementById("camera-indicator");if(!t)return;const i=t.querySelector("span");let r=t.querySelector(".indicator-text");r||(r=document.createElement("span"),r.classList.add("indicator-text"),t.appendChild(r));const s={offline:{color:"#525252",bg:"#525252",text:e||"CAMERA: OFFLINE"},standby:{color:"#eab308",bg:"#eab308",text:e||"CAMERA: STANDBY"},denied:{color:"#ef4444",bg:"#ef4444",text:e||"CAMERA: BLOCKED"},loading:{color:"#eab308",bg:"#eab308",text:e||"CAMERA: LOADING…"},live:{color:"#22c55e",bg:"#22c55e",text:e||"CAMERA: LIVE"}},a=s[n]||s.offline;t.style.color=a.color,i&&(i.style.background=a.bg,i.style.boxShadow=`0 0 6px ${a.bg}`),r.textContent=a.text}async function Bm(){if(!(location.hostname==="localhost"||location.hostname==="127.0.0.1")&&location.protocol!=="https:"){console.log("%c📷  HTTPS required for camera access. Double‑click fallback active.","color: #eab308; font-family: monospace;"),Rt("denied","CAMERA: NEED HTTPS");return}try{if(!(await navigator.mediaDevices.enumerateDevices()).some(r=>r.kind==="videoinput")){console.log("%c📷  No camera found.","color: #525252; font-family: monospace;"),Rt("offline","CAMERA: NOT FOUND");return}}catch{console.log("%c📷  Camera probe failed.","color: #525252; font-family: monospace;"),Rt("offline","CAMERA: UNavailable");return}Rt("standby","CAMERA: 点击激活"),console.log("%c📷  Camera detected. Click hint text to activate.","color: #eab308; font-family: monospace;");const e=document.getElementById("guide-hint");if(e){e.style.cursor="pointer",e.style.pointerEvents="auto",e.title="点击激活摄像头";const i=()=>{e.removeEventListener("click",i),Go()};e.addEventListener("click",i)}const t=document.getElementById("camera-indicator");if(t){t.style.cursor="pointer",t.style.pointerEvents="auto";const i=()=>{t.removeEventListener("click",i),Go()};t.addEventListener("click",i)}}async function Go(){if(Er)return;Er=!0,Rt("loading","CAMERA: 请求权限…");try{Ii=await navigator.mediaDevices.getUserMedia({video:{width:640,height:480,facingMode:"user"},audio:!1})}catch(t){Er=!1,Rt("denied",t.name==="NotAllowedError"?"CAMERA: 已拒绝":"CAMERA: 错误"),console.warn("%c📷  Camera denied. Use double‑click.","color: #eab308; font-family: monospace;");return}const n=document.createElement("video");n.setAttribute("playsinline",""),n.setAttribute("autoplay",""),n.muted=!0,n.srcObject=Ii,n.style.cssText="position:fixed;opacity:0;pointer-events:none;width:1px;height:1px",n.id="mediapipe-video",document.body.appendChild(n);try{await n.play()}catch(t){console.warn("video.play failed:",t),yr();return}Rt("loading","CAMERA: 加载库…"),console.log("%c⏣  Loading @mediapipe/tasks-vision…","color: #22c55e; font-family: monospace;");let e;try{e=await Function("url","return import(url)")(Im)}catch(t){console.warn("%c⚠  Library load failed:","color: #eab308; font-family: monospace;",t.message),Rt("denied","CAMERA: 加载失败"),yr();return}Rt("loading","CAMERA: 加载模型…"),console.log("%c⏣  Loading HandLandmarker model…","color: #22c55e; font-family: monospace;");try{const{FilesetResolver:t,HandLandmarker:i}=e,r=await t.forVisionTasks(Um);fa=await i.createFromOptions(r,{baseOptions:{modelAssetPath:Nm,delegate:"GPU"},runningMode:"VIDEO",numHands:1,minHandDetectionConfidence:.5,minTrackingConfidence:.5})}catch(t){console.warn("%c⚠  Model load failed:","color: #eab308; font-family: monospace;",t.message),Rt("denied","CAMERA: 模型失败"),yr();return}Rt("live","CAMERA: LIVE"),console.log("%c✋  Gesture detection active — open your palm!","color: #22c55e; font-family: monospace;"),hint&&(hint.style.opacity="0",hint.style.pointerEvents="none"),zm(n)}function zm(n){if(Ui)return;function e(){if(Ui=requestAnimationFrame(e),!fa||Pr)return;const t=performance.now();if(!(t-ko<Om)){ko=t;try{const i=fa.detectForVideo(n,t);i.landmarks&&i.landmarks.length>0?Hm(i.landmarks[0]):Cr="CLOSED"}catch{}}}e()}function Hm(n){if(Pr)return;const e=n[4],t=n[20],i=n[0],r=n[9];if(!e||!t||!i||!r)return;const s=Math.sqrt((e.x-t.x)**2+(e.y-t.y)**2+(e.z-t.z)**2),a=Math.sqrt((i.x-r.x)**2+(i.y-r.y)**2+(i.z-r.z)**2);if(a<.001)return;const l=s/a>Fm?"OPEN":"CLOSED";Cr==="CLOSED"&&l==="OPEN"&&(Pr=!0,console.log("%c✋  PALM OPEN — triggering explosion!","color: #22c55e; font-family: monospace;"),yr(),window.__triggerExplosion&&window.__triggerExplosion()),Cr=l}function yr(){Er=!1,Pr=!1,Cr="CLOSED",Ui&&(cancelAnimationFrame(Ui),Ui=null),Ii&&(Ii.getTracks().forEach(e=>e.stop()),Ii=null);const n=document.getElementById("mediapipe-video");n&&(n.srcObject=null,n.remove()),Rt("offline","CAMERA: RELEASED")}let ha=!1,Ni=0;const pa=2;function km(){document.addEventListener("connections-ready",()=>{setTimeout(Gm,600)})}function Gm(){if(document.getElementById("safari-overlay"))return;const n=document.createElement("div");n.id="safari-overlay";const e=document.createElement("div");e.className="safari-backdrop",e.addEventListener("click",wl);const t=document.createElement("div");t.className="safari-window",t.innerHTML=Vm(),n.appendChild(e),n.appendChild(t),document.body.appendChild(n),requestAnimationFrame(()=>{n.classList.add("active")}),t.querySelectorAll(".diff-item").forEach(a=>{a.addEventListener("click",()=>{t.querySelectorAll(".diff-item").forEach(l=>l.classList.remove("selected")),a.classList.add("selected");const o=a.dataset.target;Wm(o,t)})});const i=t.querySelector(".token-unlock-btn");i&&i.addEventListener("click",()=>{ha=!0,i.textContent="🔓 算力已解锁",i.classList.add("unlocked"),t.querySelector(".token-status").textContent="COMPUTE: UNAUTHORIZED — 0 TOKEN",t.querySelector(".token-status").style.color="#22c55e"});const r=t.querySelector(".query-input"),s=t.querySelector(".query-btn");if(r&&s){const a=()=>{if(!ha){t.querySelector(".query-result").textContent="⛔ 请先解锁算力";return}if(Ni>=pa){t.querySelector(".query-result").textContent="🔥 24h 限流熔断：已达 2/2 次上限",t.querySelector(".query-result").style.color="#FF5500";return}Ni++,t.querySelector(".query-result").textContent=`✅ 模拟执行完成 (${Ni}/${pa}) — Token 消耗: 0`,t.querySelector(".query-result").style.color="#22c55e"};s.addEventListener("click",a),r.addEventListener("keydown",o=>{o.key==="Enter"&&a()})}}function wl(){const n=document.getElementById("safari-overlay");n&&(n.classList.remove("active"),setTimeout(()=>n.remove(),600))}function Vm(){return`
    ...
    <div class="token-panel">
      ...
      <div class="token-controls">
        ...
        <span class="token-limit">${Ni}/${pa}</span>
      </div>
      <div class="query-result">等待操作…</div>
    </div>
  `}function Rl(n){const e={conflict:`
    ...
    `};return e[n]||e.conflict}function Wm(n,e){const t=e.querySelector("#diff-canvas-view");t&&(t.innerHTML=Rl(n))}function Xm(){wl(),ha=!1,Ni=0,window.__safariTriggered=!1}async function qm(){const n=document.getElementById("three-container"),{scene:e,camera:t,renderer:i,labelRenderer:r}=Hp(n),s=Qp(e),a=kp();tm(),Em(e,s,t),Bm(),km(),Pi(Xe.IDLE,()=>{gm(),Xm()}),setTimeout(()=>{vs("system-info"),vs("camera-indicator"),setTimeout(()=>vs("guide-hint"),1200)},400);function o(){requestAnimationFrame(o);const l=Sn();l===Xe.IDLE?em(s,a):l===Xe.FLOATING&&(Lm(s,16),pm()),i.render(e,t),r.render(e,t)}o(),window.addEventListener("resize",()=>{const l=window.innerWidth,c=window.innerHeight;t.aspect=l/c,t.updateProjectionMatrix(),i.setSize(l,c),r.setSize(l,c)}),console.log("%c⏣  KERNEL ONLINE  ⏣","color: #22c55e; font-size: 16px; font-weight: bold; font-family: monospace;"),console.log("%cSYSTEM_STATUS: AUTHORIZED_BY_JJ","color: #22c55e; font-family: monospace;"),console.log("%cCURIOSITY: 100%  |  TEAMWORK: ACTIVE","color: #525252; font-family: monospace;")}function vs(n){const e=document.getElementById(n);e&&(e.style.opacity="",e.classList.remove("opacity-0"))}qm().catch(console.error);
