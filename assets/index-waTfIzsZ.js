...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:yn,depthTest:!1,depthWrite:!1})}function vo(){return new wn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:La(),fragmentShader:`
		...
		`,blending:yn,depthTest:!1,depthWrite:!1})}function xo(){return new wn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:La(),fragmentShader:`
	...
	`}function Kf(n){let e=new WeakMap,t=null;function i(a){if(a&&a.isTexture){const c=a.mapping,l=c===Os||c===Bs,u=c===_i||c===vi;if(l||u){let h=e.get(a);const f=h!==void 0?h.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==f)return t===null&&(t=new go(n)),h=l?t.fromEquirectangular(a,h):t.fromCubemap(a,h),h.texture.pmremVersion=a.pmremVersion,e.set(a,h),h.texture;if(h!==void 0)return h.texture;{const m=a.image;return l&&m&&m.height>0||u&&m&&r(m)?(t===null&&(t=new go(n)),h=l?t.fromEquirectangular(a):t.fromCubemap(a),h.texture.pmremVersion=a.pmremVersion,e.set(a,h),a.addEventListener("dispose",s),h.texture):null}}}return a}function r(a){let c=0;const l=6;for(let u=0;u<l;u++)a[u]!==void 0&&c++;return c===l}function s(a){const c=a.target;c.removeEventListener("dispose",s);const l=e.get(c);l!==void 0&&(e.delete(c),l.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:i,dispose:o}}function Zf(n){const e={};function t(i){if(e[i]!==void 0)return e[i];let r;switch(i){case"WEBGL_depth_texture":r=n.getExtension("WEBGL_depth_texture")||n.getExtension("MOZ_WEBGL_depth_texture")||n.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=n.getExtension("EXT_texture_filter_anisotropic")||n.getExtension("MOZ_EXT_texture_filter_anisotropic")||n.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=n.getExtension("WEBGL_compressed_texture_s3tc")||n.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=n.getExtension("WEBGL_compressed_texture_pvrtc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=n.getExtension(i)}return e[i]=r,r}return{has:function(i){return t(i)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(i){const r=t(i);return r===null&&Ni("THREE.WebGLRenderer: "+i+" extension not supported."),r}}}function jf(n,e,t,i){const r={},s=new WeakMap;function o(h){const f=h.target;f.index!==null&&e.remove(f.index);for(const g in f.attributes)e.remove(f.attributes[g]);for(const g in f.morphAttributes){const _=f.morphAttributes[g];for(let p=0,d=_.length;p<d;p++)e.remove(_[p])}f.removeEventListener("dispose",o),delete r[f.id];const m=s.get(f);m&&(e.remove(m),s.delete(f)),i.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,t.memory.geometries--}function a(h,f){return r[f.id]===!0||(f.addEventListener("dispose",o),r[f.id]=!0,t.memory.geometries++),f}function c(h){const f=h.attributes;for(const g in f)e.update(f[g],n.ARRAY_BUFFER);const m=h.morphAttributes;for(const g in m){const _=m[g];for(let p=0,d=_.length;p<d;p++)e.update(_[p],n.ARRAY_BUFFER)}}function l(h){const f=[],m=h.index,g=h.attributes.position;let _=0;if(m!==null){const b=m.array;_=m.version;for(let E=0,M=b.length;E<M;E+=3){const U=b[E+0],R=b[E+1],w=b[E+2];f.push(U,R,R,w,w,U)}}else if(g!==void 0){const b=g.array;_=g.version;for(let E=0,M=b.length/3-1;E<M;E+=3){const U=E+0,R=E+1,w=E+2;f.push(U,R,R,w,w,U)}}else return;const p=new(ul(f)?xl:vl)(f,1);p.version=_;const d=s.get(h);d&&e.remove(d),s.set(h,p)}function u(h){const f=s.get(h);if(f){const m=h.index;m!==null&&f.version<m.version&&l(h)}else l(h);return s.get(h)}return{get:a,update:c,getWireframeAttribute:u}}function Jf(n,e,t){let i;function r(f){i=f}let s,o;function a(f){s=f.type,o=f.bytesPerElement}function c(f,m){n.drawElements(i,m,s,f*o),t.update(m,i,1)}function l(f,m,g){g!==0&&(n.drawElementsInstanced(i,m,s,f*o,g),t.update(m,i,g))}function u(f,m,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,m,0,s,f,0,g);let p=0;for(let d=0;d<g;d++)p+=m[d];t.update(p,i,1)}function h(f,m,g,_){if(g===0)return;const p=e.get("WEBGL_multi_draw");if(p===null)for(let d=0;d<f.length;d++)l(f[d]/o,m[d],_[d]);else{p.multiDrawElementsInstancedWEBGL(i,m,0,s,f,0,_,0,g);let d=0;for(let b=0;b<g;b++)d+=m[b]*_[b];t.update(d,i,1)}}this.setMode=r,this.setIndex=a,this.render=c,this.renderInstances=l,this.renderMultiDraw=u,this.renderMultiDrawInstances=h}function Qf(n){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,o,a){switch(t.calls++,o){case n.TRIANGLES:t.triangles+=a*(s/3);break;case n.LINES:t.lines+=a*(s/2);break;case n.LINE_STRIP:t.lines+=a*(s-1);break;case n.LINE_LOOP:t.lines+=a*s;break;case n.POINTS:t.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:i}}function eh(n,e,t){const i=new WeakMap,r=new rt;function s(o,a,c){const l=o.morphTargetInfluences,u=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,h=u!==void 0?u.length:0;let f=i.get(a);if(f===void 0||f.count!==h){let S=function(){I.dispose(),i.delete(a),a.removeEventListener("dispose",S)};var m=S;f!==void 0&&f.texture.dispose();const g=a.morphAttributes.position!==void 0,_=a.morphAttributes.normal!==void 0,p=a.morphAttributes.color!==void 0,d=a.morphAttributes.position||[],b=a.morphAttributes.normal||[],E=a.morphAttributes.color||[];let M=0;g===!0&&(M=1),_===!0&&(M=2),p===!0&&(M=3);let U=a.attributes.position.count*M,R=1;U>e.maxTextureSize&&(R=Math.ceil(U/e.maxTextureSize),U=e.maxTextureSize);const w=new Float32Array(U*R*4*h),I=new hl(w,U,R,h);I.type=rn,I.needsUpdate=!0;const y=M*4;for(let A=0;A<h;A++){const G=d[A],z=b[A],$=E[A],K=U*R*4*A;for(let X=0;X<G.count;X++){const j=X*y;g===!0&&(r.fromBufferAttribute(G,X),w[K+j+0]=r.x,w[K+j+1]=r.y,w[K+j+2]=r.z,w[K+j+3]=0),_===!0&&(r.fromBufferAttribute(z,X),w[K+j+4]=r.x,w[K+j+5]=r.y,w[K+j+6]=r.z,w[K+j+7]=0),p===!0&&(r.fromBufferAttribute($,X),w[K+j+8]=r.x,w[K+j+9]=r.y,w[K+j+10]=r.z,w[K+j+11]=$.itemSize===4?r.w:1)}}f={count:h,texture:I,size:new Ye(U,R)},i.set(a,f),a.addEventListener("dispose",S)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)c.getUniforms().setValue(n,"morphTexture",o.morphTexture,t);else{let g=0;for(let p=0;p<l.length;p++)g+=l[p];const _=a.morphTargetsRelative?1:1-g;c.getUniforms().setValue(n,"morphTargetBaseInfluence",_),c.getUniforms().setValue(n,"morphTargetInfluences",l)}c.getUniforms().setValue(n,"morphTargetsTexture",f.texture,t),c.getUniforms().setValue(n,"morphTargetsTextureSize",f.size)}return{update:s}}function th(n,e,t,i){let r=new WeakMap;function s(c){const l=i.render.frame,u=c.geometry,h=e.get(c,u);if(r.get(h)!==l&&(e.update(h),r.set(h,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",a)===!1&&c.addEventListener("dispose",a),r.get(c)!==l&&(t.update(c.instanceMatrix,n.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,n.ARRAY_BUFFER),r.set(c,l))),c.isSkinnedMesh){const f=c.skeleton;r.get(f)!==l&&(f.update(),r.set(f,l))}return h}function o(){r=new WeakMap}function a(c){const l=c.target;l.removeEventListener("dispose",a),t.remove(l.instanceMatrix),l.instanceColor!==null&&t.remove(l.instanceColor)}return{update:s,dispose:o}}class bl extends pt{constructor(e,t,i,r,s,o,a,c,l,u=fi){if(u!==fi&&u!==Mi)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");i===void 0&&u===fi&&(i=Wn),i===void 0&&u===Mi&&(i=xi),super(null,r,s,o,a,c,u,i,l),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=a!==void 0?a:Ht,this.minFilter=c!==void 0?c:Ht,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const Al=new pt,Mo=new bl(1,1),wl=new hl,Rl=new zc,Cl=new El,So=[],Eo=[],yo=new Float32Array(16),To=new Float32Array(9),bo=new Float32Array(4);function Ti(n,e,t){const i=n[0];if(i<=0||i>0)return n;const r=e*t;let s=So[r];if(s===void 0&&(s=new Float32Array(r),So[r]=s),e!==0){i.toArray(s,0);for(let o=1,a=0;o!==e;++o)a+=t,n[o].toArray(s,a)}return s}function at(n,e){if(n.length!==e.length)return!1;for(let t=0,i=n.length;t<i;t++)if(n[t]!==e[t])return!1;return!0}function ot(n,e){for(let t=0,i=e.length;t<i;t++)n[t]=e[t]}function Wr(n,e){let t=Eo[e];t===void 0&&(t=new Int32Array(e),Eo[e]=t);for(let i=0;i!==e;++i)t[i]=n.allocateTextureUnit();return t}function nh(n,e){const t=this.cache;t[0]!==e&&(n.uniform1f(this.addr,e),t[0]=e)}function ih(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(at(t,e))return;n.uniform2fv(this.addr,e),ot(t,e)}}function rh(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(at(t,e))return;n.uniform3fv(this.addr,e),ot(t,e)}}function sh(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(at(t,e))return;n.uniform4fv(this.addr,e),ot(t,e)}}function ah(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(at(t,e))return;n.uniformMatrix2fv(this.addr,!1,e),ot(t,e)}else{if(at(t,i))return;bo.set(i),n.uniformMatrix2fv(this.addr,!1,bo),ot(t,i)}}function oh(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(at(t,e))return;n.uniformMatrix3fv(this.addr,!1,e),ot(t,e)}else{if(at(t,i))return;To.set(i),n.uniformMatrix3fv(this.addr,!1,To),ot(t,i)}}function lh(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(at(t,e))return;n.uniformMatrix4fv(this.addr,!1,e),ot(t,e)}else{if(at(t,i))return;yo.set(i),n.uniformMatrix4fv(this.addr,!1,yo),ot(t,i)}}function ch(n,e){const t=this.cache;t[0]!==e&&(n.uniform1i(this.addr,e),t[0]=e)}function dh(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(at(t,e))return;n.uniform2iv(this.addr,e),ot(t,e)}}function uh(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(at(t,e))return;n.uniform3iv(this.addr,e),ot(t,e)}}function fh(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(at(t,e))return;n.uniform4iv(this.addr,e),ot(t,e)}}function hh(n,e){const t=this.cache;t[0]!==e&&(n.uniform1ui(this.addr,e),t[0]=e)}function ph(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(at(t,e))return;n.uniform2uiv(this.addr,e),ot(t,e)}}function mh(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(at(t,e))return;n.uniform3uiv(this.addr,e),ot(t,e)}}function gh(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(at(t,e))return;n.uniform4uiv(this.addr,e),ot(t,e)}}function _h(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r);let s;this.type===n.SAMPLER_2D_SHADOW?(Mo.compareFunction=dl,s=Mo):s=Al,t.setTexture2D(e||s,r)}function vh(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture3D(e||Rl,r)}function xh(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTextureCube(e||Cl,r)}function Mh(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture2DArray(e||wl,r)}function Sh(n){switch(n){case 5126:return nh;case 35664:return ih;case 35665:return rh;case 35666:return sh;case 35674:return ah;case 35675:return oh;case 35676:return lh;case 5124:case 35670:return ch;case 35667:case 35671:return dh;case 35668:case 35672:return uh;case 35669:case 35673:return fh;case 5125:return hh;case 36294:return ph;case 36295:return mh;case 36296:return gh;case 35678:case 36198:case 36298:case 36306:case 35682:return _h;case 35679:case 36299:case 36307:return vh;case 35680:case 36300:case 36308:case 36293:return xh;case 36289:case 36303:case 36311:case 36292:return Mh}}function Eh(n,e){n.uniform1fv(this.addr,e)}function yh(n,e){const t=Ti(e,this.size,2);n.uniform2fv(this.addr,t)}function Th(n,e){const t=Ti(e,this.size,3);n.uniform3fv(this.addr,t)}function bh(n,e){const t=Ti(e,this.size,4);n.uniform4fv(this.addr,t)}function Ah(n,e){const t=Ti(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,t)}function wh(n,e){const t=Ti(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,t)}function Rh(n,e){const t=Ti(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,t)}function Ch(n,e){n.uniform1iv(this.addr,e)}function Lh(n,e){n.uniform2iv(this.addr,e)}function Ph(n,e){n.uniform3iv(this.addr,e)}function Dh(n,e){n.uniform4iv(this.addr,e)}function Ih(n,e){n.uniform1uiv(this.addr,e)}function Uh(n,e){n.uniform2uiv(this.addr,e)}function Nh(n,e){n.uniform3uiv(this.addr,e)}function Fh(n,e){n.uniform4uiv(this.addr,e)}function Oh(n,e,t){const i=this.cache,r=e.length,s=Wr(t,r);at(i,s)||(n.uniform1iv(this.addr,s),ot(i,s));for(let o=0;o!==r;++o)t.setTexture2D(e[o]||Al,s[o])}function Bh(n,e,t){const i=this.cache,r=e.length,s=Wr(t,r);at(i,s)||(n.uniform1iv(this.addr,s),ot(i,s));for(let o=0;o!==r;++o)t.setTexture3D(e[o]||Rl,s[o])}function zh(n,e,t){const i=this.cache,r=e.length,s=Wr(t,r);at(i,s)||(n.uniform1iv(this.addr,s),ot(i,s));for(let o=0;o!==r;++o)t.setTextureCube(e[o]||Cl,s[o])}function Hh(n,e,t){const i=this.cache,r=e.length,s=Wr(t,r);at(i,s)||(n.uniform1iv(this.addr,s),ot(i,s));for(let o=0;o!==r;++o)t.setTexture2DArray(e[o]||wl,s[o])}function kh(n){switch(n){case 5126:return Eh;case 35664:return yh;case 35665:return Th;case 35666:return bh;case 35674:return Ah;case 35675:return wh;case 35676:return Rh;case 5124:case 35670:return Ch;case 35667:case 35671:return Lh;case 35668:case 35672:return Ph;case 35669:case 35673:return Dh;case 5125:return Ih;case 36294:return Uh;case 36295:return Nh;case 36296:return Fh;case 35678:case 36198:case 36298:case 36306:case 35682:return Oh;case 35679:case 36299:case 36307:return Bh;case 35680:case 36300:case 36308:case 36293:return zh;case 36289:case 36303:case 36311:case 36292:return Hh}}class Gh{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.setValue=Sh(t.type)}}class Vh{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=kh(t.type)}}class Wh{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(e,t[a.id],i)}}}const Ms=/(\w+)(\])?(\[|\.)?/g;function Ao(n,e){n.seq.push(e),n.map[e.id]=e}function Xh(n,e,t){const i=n.name,r=i.length;for(Ms.lastIndex=0;;){const s=Ms.exec(i),o=Ms.lastIndex;let a=s[1];const c=s[2]==="]",l=s[3];if(c&&(a=a|0),l===void 0||l==="["&&o+2===r){Ao(t,l===void 0?new Gh(a,n,e):new Vh(a,n,e));break}else{let h=t.map[a];h===void 0&&(h=new Wh(a),Ao(t,h)),t=h}}}class Cr{constructor(e,t){this.seq=[],this.map={};const i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<i;++r){const s=e.getActiveUniform(t,r),o=e.getUniformLocation(t,s.name);Xh(s,o,this)}}setValue(e,t,i,r){const s=this.map[t];s!==void 0&&s.setValue(e,i,r)}setOptional(e,t,i){const r=t[i];r!==void 0&&this.setValue(e,i,r)}static upload(e,t,i,r){for(let s=0,o=t.length;s!==o;++s){const a=t[s],c=i[a.id];c.needsUpdate!==!1&&a.setValue(e,c.value,r)}}static seqWithValue(e,t){const i=[];for(let r=0,s=e.length;r!==s;++r){const o=e[r];o.id in t&&i.push(o)}return i}}function wo(n,e,t){const i=n.createShader(e);return n.shaderSource(i,t),n.compileShader(i),i}const qh=37297;let Yh=0;function $h(n,e){const t=n.split(`
`),i=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let o=r;o<s;o++){const a=o+1;i.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return i.join(`
`)}const Ro=new Ce;function Kh(n){ze._getMatrix(Ro,ze.workingColorSpace,n);const e=`mat3( ${Ro.elements.map(t=>t.toFixed(4))} )`;switch(ze.getTransfer(n)){case kr:return[e,"LinearTransferOETF"];case qe:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",n),[e,"LinearTransferOETF"]}}function Co(n,e,t){const i=n.getShaderParameter(e,n.COMPILE_STATUS),r=n.getShaderInfoLog(e).trim();if(i&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const o=parseInt(s[1]);return t.toUpperCase()+`

`+r+`

`+$h(n.getShaderSource(e),o)}else return r}function Zh(n,e){const t=Kh(e);return[`vec4 ${n}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function jh(n,e){let t;switch(e){case uc:t="Linear";break;case fc:t="Reinhard";break;case hc:t="Cineon";break;case pc:t="ACESFilmic";break;case gc:t="AgX";break;case _c:t="Neutral";break;case mc:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Mr=new F;function Jh(){ze.getLuminanceCoefficients(Mr);const n=Mr.x.toFixed(4),e=Mr.y.toFixed(4),t=Mr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function Qh(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",n.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Fi).join(`
`)}function ep(n){const e=[];for(const t in n){const i=n[t];i!==!1&&e.push("#define "+t+" "+i)}return e.join(`
`)}function tp(n,e){const t={},i=n.getProgramParameter(e,n.ACTIVE_ATTRIBUTES);for(let r=0;r<i;r++){const s=n.getActiveAttrib(e,r),o=s.name;let a=1;s.type===n.FLOAT_MAT2&&(a=2),s.type===n.FLOAT_MAT3&&(a=3),s.type===n.FLOAT_MAT4&&(a=4),t[o]={type:s.type,location:n.getAttribLocation(e,o),locationSize:a}}return t}function Fi(n){return n!==""}function Lo(n,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return n.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Po(n,e){return n.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const np=/^[ \t]*#include +<([\w\d./]+)>/gm;function pa(n){return n.replace(np,rp)}const ip=new Map;function rp(n,e){let t=Pe[e];if(t===void 0){const i=ip.get(e);if(i!==void 0)t=Pe[i],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,i);else throw new Error("Can not resolve #include <"+e+">")}return pa(t)}const sp=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Do(n){return n.replace(sp,ap)}function ap(n,e,t,i){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=i.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function Io(n){let e=`precision ${n.precision} float;
...
#define LOW_PRECISION`),e}function op(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===jo?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===Wl?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===tn&&(e="SHADOWMAP_TYPE_VSM"),e}function lp(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case _i:case vi:e="ENVMAP_TYPE_CUBE";break;case Hr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function cp(n){let e="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case vi:e="ENVMAP_MODE_REFRACTION";break}return e}function dp(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case Jo:e="ENVMAP_BLENDING_MULTIPLY";break;case cc:e="ENVMAP_BLENDING_MIX";break;case dc:e="ENVMAP_BLENDING_ADD";break}return e}function up(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:i,maxMip:t}}function fp(n,e,t,i){const r=n.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const c=op(t),l=lp(t),u=cp(t),h=dp(t),f=up(t),m=Qh(t),g=ep(s),_=r.createProgram();let p,d,b=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
  ...
  `,n.isName&&(e.style.backgroundColor="transparent"),e}function om(n){const e=document.createElement("div");return e.className="project-label",e.dataset.key=n.key,e.innerHTML=`
  ...
  `,e}function lm(n,e){const t=new Oi,i=e?250:1200,r=e?1.8:4.8,s=new dn;s.setAttribute("position",new kt(ys(i,r),3));const o=new Ll({size:.18,map:sm(),blending:ws,depthWrite:!1,transparent:!0,color:new We(.133,.773,.369),opacity:.75,sizeAttenuation:!0}),a=new Yp(s,o);t.add(a);const c=new Float32Array(s.attributes.position.array),l=s.attributes.position.array,u=[];let h=null;rm(e).forEach(b=>{const E=am(b),M=new Es(E);M.position.set(b.x,b.y,b.z),t.add(M),u.push({obj:M,el:E,data:b}),b.isName&&(h={obj:M,el:E,data:b})});const f=ys(Wo.length,r*1.04),m=[],g=e?.5:1;Wo.forEach((b,E)=>{const M=document.createElement("span");M.textContent=b.text,M.style.cssText=`
      font-family: 'Space Mono', 'Courier New', monospace;
    ...
    `;const U=new Es(M);U.position.set(f[E*3],f[E*3+1],f[E*3+2]),t.add(U),m.push({obj:U,el:M,data:b})});const _=null,p=ys(Xo.length,r*1.02),d=[];return Xo.forEach((b,E)=>{const M=om(b),U=new Es(M);U.position.set(p[E*3],p[E*3+1],p[E*3+2]),t.add(U),d.push({obj:U,el:M,data:b,idx:E})}),n.add(t),{group:t,particles:a,particleMat:o,particleGeo:s,origPos:c,particlePos:l,nodeRefs:d,infoRefs:u,nameRef:h,nameFixedEl:_,tagRefs:m,velocities:null,targets:null,exploding:!1,explosionProgress:0}}function cm(n,e){if(Xt()!==ke.IDLE)return;Jp(e,.055),n._autoRotY=(n._autoRotY||0)+tm,n._wobbleX=(n._wobbleX||0)+Math.sin(Date.now()*3e-4)*15e-5,n.group.rotation.y=n._autoRotY+e.currentX*.08,n.group.rotation.x=n._wobbleX+e.currentY*.08;const t=1+Math.sin(Date.now()*im*.001)*nm;n.group.scale.setScalar(t),n.particleMat.opacity=.6+Math.sin(Date.now()*.0015)*.15}function dm(){const n=document.getElementById("status-bar");n&&(n.innerHTML=`
...
● 核心突破
→ 复杂业务解构：负责全类型项目分摊与跨项目报工、阶段性劳务报工管理、经营性项目关联研发项目等相关需求梳理与方案产出，涉及现有系统逻辑重构。`}};let Pt=null,Nr=!1;function um(n){if(Nr){Fr();return}const t=qo[{a1:"a1",a2:"a2",b1:"b1",b2:"b2",b3:"b3"}[n]]||qo.a1;fm(),hm(t),document.body.style.overflow="hidden",Pt.classList.add("active"),Nr=!0}function Fr(){!Pt||!Nr||(Pt.classList.remove("active"),Nr=!1,document.body.style.overflow="")}function fm(){if(Pt){Pt.innerHTML="";return}Pt=document.createElement("div"),Pt.id="terminal-overlay",document.body.appendChild(Pt)}function hm(n){Pt.innerHTML=`
    <!-- backdrop -->
  ...
  `,Pt.querySelectorAll(".bb-image video").forEach(e=>{const t=e.dataset.src;t&&(e.src=t,e.addEventListener("error",()=>{const i=e.closest(".bb-image")||e.parentElement;if(!i)return;const r=i.closest(".tt-browser");if(!r)return;const s=r.querySelector(".bb-bar"),o=document.createElement("div");o.className="bb-content";const a=s==null?void 0:s.querySelector(".bb-url span:last-child"),c=(a==null?void 0:a.textContent)||n.title||"";o.innerHTML=`
      ...
      `,e.remove(),i.replaceWith(o)}),setTimeout(()=>{e.paused&&e.play().catch(()=>{})},200))}),Pt.querySelector("#tt-close").addEventListener("click",Fr),Pt.querySelector(".tt-backdrop").addEventListener("click",Fr)}function pm(n){return n.split(`
`).map(t=>{const i=t.trim();return i?i.startsWith("【")?`<div class="cl-section"><span class="cl-dot">●</span> ${zn(i.replace(/[【】]/g,""))}</div>`:i.startsWith("●")?`<div class="cl-section"><span class="cl-dot">●</span> ${zn(i.slice(1).trim())}</div>`:i.startsWith("→")?`<div class="cl-bullet"><span class="cl-arrow">→</span>${zn(i.slice(1).trim())}</div>`:/\d+%/.test(i)||/\d+ 项/.test(i)||/^\d+/.test(i)?`<div class="cl-highlight">${zn(i)}</div>`:`<div class="cl-line">${zn(i)}</div>`:'<div class="cl-empty"></div>'}).join("")}function zn(n){return n.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}let Wt=null;const mm={b1:{name:"科技管理应用",tag:"B端·科技管理"},b2:{name:"巡查问题在线管理",tag:"B端·合规治理"},b3:{name:"项目管理应用",tag:"B端·全生命周期"}};function Pl(n){const e=document.getElementById("sim-rare-overlay");e&&e.remove(),Wt=null;const t=mm[n]||{name:"未知项目"};Wt=document.createElement("div"),Wt.id="sim-rare-overlay",Wt.innerHTML=`
  ...
  `}function Fl(n){const e={conflict:`
    ...
    `};return e[n]||e.conflict}function Qm(n,e){const t=e.querySelector("#diff-canvas-view");t&&(t.innerHTML=Fl(n))}function eg(){Nl(),Sa=!1,Vi=0,window.__safariTriggered=!1}let Ot=null,wt=0,Vn=0,xn=0,bn=null,mi=null,Wi=0;function tg(){if(Ot){Ot.style.display="";return}Ot=document.createElement("div"),Ot.id="contact-overlay",Ot.innerHTML=`
  ...
  `,document.body.appendChild(Ot)}function Zo(){const n=document.getElementById("co-scroll-container");if(!n)return;const e=(1-wt)*100;n.style.transform=`translateY(${e}%)`,Ot.style.pointerEvents=wt>.02?"auto":"none",Ot.style.opacity=wt>.02?"1":"0"}function Ol(n){bn=requestAnimationFrame(Ol);const e=Math.min((n-(Wi||n))/16,4);Wi=n;const t=.045*e,r=(Vn-wt)*t-xn*.8;xn+=r*e,wt+=xn*e,wt<0&&(wt=0,xn=0),wt>1&&(wt=1,xn=0),Zo(),Math.abs(wt-Vn)<.003&&Math.abs(xn)<5e-4&&(wt=Vn,xn=0,Zo(),cancelAnimationFrame(bn),bn=null,Wi=0)}function Bl(){bn||(Wi=0,bn=requestAnimationFrame(Ol))}function ng(n){mi||(tg(),mi=e=>{Vn=Math.max(0,Math.min(1,Vn+e.deltaY/500)),Bl()},n.addEventListener("wheel",mi,{passive:!0}))}function ig(n){if(!mi)return;n.removeEventListener("wheel",mi),mi=null,Vn=0,wt=0,xn=0,Wi=0,bn&&(cancelAnimationFrame(bn),bn=null);const e=document.getElementById("co-scroll-container");e&&(e.style.transform="translateY(100%)"),Ot&&(Ot.style.opacity="0",Ot.style.pointerEvents="none")}document.addEventListener("keydown",n=>{n.key==="Escape"&&(Vn=0,Bl())});async function rg(){const n=document.getElementById("three-container"),e=window.innerWidth<768,{scene:t,camera:i,renderer:r,labelRenderer:s}=Zp(n,e),o=lm(t,e),a=jp();dm(),Pm(t,o,i),Ym(),Zm(),Bi(ke.IDLE,()=>{bm(),eg()}),setTimeout(()=>{As("system-info"),As("camera-indicator"),setTimeout(()=>As("guide-hint"),1200)},400);function c(){requestAnimationFrame(c);const l=Xt();l===ke.IDLE?(cm(o,a),window.__contactMounted&&(ig(window),window.__contactMounted=!1)):l===ke.FLOATING&&(Hm(o,16),ym(),window.__contactMounted||(ng(window),window.__contactMounted=!0)),r.render(t,i),s.render(t,i)}c(),window.addEventListener("resize",()=>{const l=window.innerWidth,u=window.innerHeight;i.aspect=l/u,i.updateProjectionMatrix(),r.setSize(l,u),s.setSize(l,u)}),console.log("%c⏣  KERNEL ONLINE  ⏣","color: #22c55e; font-size: 16px; font-weight: bold; font-family: monospace;"),console.log("%cSYSTEM_STATUS: AUTHORIZED_BY_JJ","color: #22c55e; font-family: monospace;"),console.log("%cCURIOSITY: 100%  |  TEAMWORK: ACTIVE","color: #525252; font-family: monospace;")}function As(n){const e=document.getElementById(n);e&&(e.style.opacity="",e.classList.remove("opacity-0"))}rg().catch(console.error);
