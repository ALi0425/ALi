...
const NODE_PROFILES = {
  a1: {
    ...
    content: `【项目定位】面向企业高层的通用型大模型资产盘点与战略决策导航系统

【产品定义】基于 n8n 的双驱动数据治理流水线，集成自动化数据多模态清洗、外部情报异步抓取与红蓝双色拓扑染色交互，旨在盘点内部资产并识别外部战略盲区。
...
【交付成果】实现智能决策闭环，用户点击红色盲区节点可自动触发混合检索并捞取外部趋势。`,
  },
  a2: {
    ...
    content: `【项目定位】针对大型遗留系统"文档缺失、代码断层、需求变更影响面难评估"的 AI4SE 效能工具。

【产品定义】基于 AIGC 逆向工程流水线的多层嵌套交互画布系统，通过将需求描述翻译为结构化算子，实现代码黑盒解构、变更冲击预警以及需求与代码的双向自动推演。
...
【交付成果】构建了可视化的嵌套交互画布，打破代码黑盒。`,
  ...
  b1: {
    ...
    content: `【项目定位】面向国网信通的万级数据量、53家单位协同的大型信息化核心科技管理系统。

【产品定义】涵盖科技项目、成果、奖励、查询统计四大业务模块，共计3期的全流程线上化闭环系统架构。
...
【交付成果】纳管科研项目 2087 项、科研成果 17805 项。全流程 100% 线上化，评定周期缩短 40%，效率提升 60%+。荣获 2021 电力科技管理创新成果一等奖。`,
  },
  b2: {
    title: '巡查问题在线管理',
    ...
    content: `【项目定位】面向集团万级数据量大型系统，聚焦巡察问题全生命周期的数字化与合规化双审治理。

【产品定义】针对大型信息化系统中的监督整改痛点，支撑巡查问题从创建任务、自动分配人才到问题下发、整改过程双审监督全流程线上化。
...
【交付成果】独立编制全套规范材料，成功支撑巡察问题数字化管理系统在多级单位间的协同运转。`,
  },
  b3: {
    title: '项目管理应用',
    ...
    content: `【项目定位】面向企业大型系统万级数据量，涵盖全类型项目全生命周期管理。

【产品定义】支撑53家单位进行项目立项、进度管理、交付物管理、人员报工、结算等业务操作，并与营销、财务、物资、人资等模块高度协同。

【核心突破】复杂业务解构：负责全类型项目分摊与跨项目报工、阶段性劳务报工管理、经营性项目关联研发项目等相关需求梳理与方案产出，涉及现有系统逻辑重构。`,
  },
}
