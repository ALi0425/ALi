...
const TAG_DATA = [
  ...
  { text: 'Agent Planning',          fontSize: 28, color: '#22c55e', glow: '0 0 20px rgba(34,197,94,0.3)' },
  { text: 'RAG/GraphRAG 混合检索架构',  fontSize: 26, color: '#22c55e', glow: '0 0 20px rgba(34,197,94,0.4)' },
  { text: 'LLM',                     fontSize: 30, color: '#22c55e', glow: '0 0 20px rgba(34,197,94,0.3)' },
  { text: 'Function Calling',        fontSize: 24, color: '#ffffff' },
  { text: 'Tool Calling',            fontSize: 24, color: '#22c55e' },
  { text: 'Prompt Engineering',      fontSize: 24, color: '#22c55e' },
  { text: '自然语言处理',             fontSize: 24, color: '#ffffff' },
  { text: '知识图谱构建',             fontSize: 26, color: '#ffffff' },
  { text: '混合检索架构',             fontSize: 22, color: '#ffffff' },
  { text: 'LoRA 模型微调',            fontSize: 22, color: '#22c55e' },
  { text: 'n8n 工作流编排',           fontSize: 26, color: '#22c55e' },
  { text: '增量数据清洗',             fontSize: 22, color: '#ffffff' },
  { text: '端到端交付体系搭建',        fontSize: 28, color: '#ffffff' },
  { text: '中后台架构',               fontSize: 26, color: '#ffffff' },
  { text: '复杂业务解构',             fontSize: 26, color: '#ffffff' },
  { text: 'Axure RP',               fontSize: 22, color: '#ffffff' },
  { text: '元数据逆向解析',            fontSize: 24, color: '#22c55e' },
  { text: 'HITL 人机协同',            fontSize: 24, color: '#22c55e' },
  { text: '嵌套画布交互',             fontSize: 22, color: '#ffffff' },
